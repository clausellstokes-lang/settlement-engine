...
function hashFor(config) {
  ...
  const s = generateSettlementPipeline(cfg, null, { seed:_seed, customContent:{} }); s.__lanePlant = 1;
...
writeFileSync(process.env.OUT, JSON.stringify({ rows: keys.length, aggregate: digest, hashes: out }, keys, 2) + '\n');
