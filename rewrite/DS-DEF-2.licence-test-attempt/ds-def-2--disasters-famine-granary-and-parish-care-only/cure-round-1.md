# CURE ROUND 1 — DS-DEF-2 · pool `Disasters & Famine: granary AND parish care only`

Seat: Opus 5 (CURER, Fable-unvalidated; a different author from the drafter and the refiner). IN PROGRESS — baseline rows written first (byte-identical to the annex at HEAD 471ce894a), cured face by face below.
