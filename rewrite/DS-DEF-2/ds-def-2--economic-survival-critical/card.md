THE CARD (mechanical sections) — block DS-DEF-2 · pool `Economic Survival: CRITICAL` · dir ds-def-2-economic-survival-critical

(1) THE KEY AND ITS PREIMAGE
  key function: ECONOMIC_ROW_POOL (rung table) · site defense.threatAssessment
  census predicate: scoreBand(economicScore) (via ECONOMIC_ROW_POOL in defenseStateProse.js) === CRITICAL
  ...
  the key FIXES: economicScore:range=[0,19] · leaves OPEN: economicScore   (economicRowPoolKey, 20 combination(s))
  preimage on the 768-town rate grid: 72 towns (938 bp) — thorp 22/128 · hamlet 23/128 · village 27/128
