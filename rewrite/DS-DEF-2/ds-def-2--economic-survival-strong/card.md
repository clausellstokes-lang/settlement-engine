THE CARD (mechanical sections) — block DS-DEF-2 · pool `Economic Survival: STRONG` · dir ds-def-2-economic-survival-strong

(1) THE KEY AND ITS PREIMAGE
  key function: ECONOMIC_ROW_POOL (rung table) · site defense.threatAssessment
  census predicate: scoreBand(economicScore) (via ECONOMIC_ROW_POOL in defenseStateProse.js) === STRONG
  ...
  the key FIXES: economicScore:range=[65,100] · leaves OPEN: economicScore   (economicRowPoolKey, 36 combination(s))
  preimage on the 768-town rate grid: 340 towns (4427 bp) — town 104/128 · city 115/128 · metropolis 121/128
