THE CARD (mechanical sections) — block DS-DEF-1 · pool `readiness ADEQUATE` · dir ds-def-1-readiness-adequate

(1) THE KEY AND ITS PREIMAGE
  key function: READINESS_ROW_POOL (rung table) · site defense.postureHeader
  census predicate: scoreBand(readinessScore) (via READINESS_ROW_POOL in defenseStateProse.js) === ADEQUATE
  ...
  the key FIXES: readinessScore:range=[40,64] · leaves OPEN: readinessScore   (posturePoolKey, 25 combination(s))
  preimage on the 768-town rate grid: 197 towns (2565 bp) — hamlet 1/128 · village 16/128 · town 91/128 · city 63/128 · metropolis 26/128
  silent tiers: thorp
