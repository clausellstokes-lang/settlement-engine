...
import { compromisedSecurityInstitutions, npcHomeInstitution, SECURITY_INSTITUTION_RE } from '/private/tmp/claude-502/-Users-cstokes-Desktop-settlement-engine/26b2203a-14d7-409e-a7aa-8d0f3b0517db/scratchpad/skepSEAM/src/domain/corruption.js';
import { HOLDER_KINDS, holdersOf, standingOf } from '/private/tmp/claude-502/-Users-cstokes-Desktop-settlement-engine/26b2203a-14d7-409e-a7aa-8d0f3b0517db/scratchpad/skepSEAM/src/domain/prose/holderTable.js';
const census = JSON.parse(readFileSync('/private/tmp/claude-502/-Users-cstokes-Desktop-settlement-engine/26b2203a-14d7-409e-a7aa-8d0f3b0517db/scratchpad/skepSEAM/docs/content/wiring-census.json','utf8'));
