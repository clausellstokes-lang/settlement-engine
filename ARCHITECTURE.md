...
- **migrations/** (142) — prod applied head tracked in `supabase/applied-head.json`,
...
- **functions/** (17 Deno edge functions) (Deno edge):
...
- **test** — Vitest, ~11,900 tests / ~1175 files (unit, property-based, domain/
