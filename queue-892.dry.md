...
- **B1 AMENDED — four §891-train lanes and the herald cure car were named and never enrolled** (CAPACITY, CHARSET Car 1, DESKWIRING, READERREVIEW Car 2; seals cited nowhere): enrolled and ruled at §892.1.
...
- **D1 AMENDED — no withdrawn ruling carried a forward pointer**, because the queue was never edited in place during the span: §883.6, §884 (the wizardNews deferral), §884.4 (Hazard 1's cause), §885 ("DISPROVES"), §887.2, §889.3, §882.10 (§17.4), §882.13 (row 6's kind; 5b's fence 3) and §882.15b (the counter-evidence) now carry `⛔ SUPERSEDED at §N` inside their rulings.
