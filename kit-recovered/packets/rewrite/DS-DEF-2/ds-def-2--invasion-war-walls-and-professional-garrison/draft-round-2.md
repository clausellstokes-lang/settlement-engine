...
- **The page fact.** No face opens on the works in the words the `Beasts & Monsters` paragraph above can use; seven of the twelve open on something other than the defences entirely (the books, a purse, a bookkeeper, the garrison, a stranger, traders, repair work, the paid men).
