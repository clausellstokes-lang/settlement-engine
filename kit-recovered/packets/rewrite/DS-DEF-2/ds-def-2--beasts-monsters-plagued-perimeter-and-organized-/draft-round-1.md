...
Status: IN PROGRESS — variant 1 on disk.
...
3. `[unfolding]` What stands at {settlement} is a wall and a muster. What is left open is the country beyond them, and it is full of creatures.
   ...
   - `[face]` The country is the open matter at {settlement}. The people who walk the wall tell it one way and the people who pay for the walking tell it another, and the record takes neither side.
