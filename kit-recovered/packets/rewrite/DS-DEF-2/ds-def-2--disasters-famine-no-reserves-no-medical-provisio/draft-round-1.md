...
2. `[street]` When the food runs short the asking starts at a neighbour's door, and when somebody falls ill it is the same door. Neither has a door of its own.
   - `[face]` What stands in for a store here is knowing which houses would say they have nothing, and what stands in for a sick-house is somebody's own room.
...
3. `[visitor]` The answer a stranger gets at {settlement}, whether he asks after the store or after the sick-house, is a name and a door.
   - `[face]` A traveller taken ill at {settlement} becomes the business of whichever roof he is under. No room is set apart for him, and he has no claim on anybody's store.
...
|---|---|---|---|---|---|
| 1 main | `{settlement} holds` | the flat entry: subject is the settlement, both absences in one clause pair | the sick | 1 | 19 |
...
| 1 f4 | `Whatever is` | fronted free relative + locative; the passive nursing clause | beds | 1 | 25 |
| 2 main | `When the` | paired temporal clauses converging on one door, then a short close | own | 2 | 29 |
| 2 f2 | `What stands` | parallel substitution (what stands in for X is Y) | room | 1 | 26 |
| 2 f3 | `Food reaching` | two sources traced to households, then a four-word close | count | 2 | 31 |
| 2 f4 | `Somebody who` | a person in a room, then the store found in the same room | room | 2 | 31 |
| 3 main | `The answer` | the answer as the subject, the two askings inside a concessive | door | 1 | 23 |
| 3 f2 | `A traveller` | the stranger's own case, then two denials that fall on him | store | 2 | 28 |
| 3 f3 | `Every room` | what he sees before he is told anything | sickness | 1 | 26 |
| 3 f4 | `A stranger` | he is sent to a household, and the household's terms are open | roof | 1 | 33 |

Spread held: twelve distinct openers · no two variants share their first two words (A11) · sentence counts 1/2/1/1, 2/1/2/2, 1/2/1/1 · lengths 19 to 33 · `{settlement}` opens exactly one variant (vid 1) and is buried in vid 3 (order constraint 10) · vid 2 carries no slot in any of its four wordings · zero semicolons, zero colons, zero em dashes, zero digits, zero which-clauses, zero questions, zero second person.
...
- *which is to endure it* (shipped vid 2) — a hard-wall which-clause and a gloss. Zero which-clauses in the twelve.
...
*Main line — "{settlement} holds no store in common against a bad year and gives no room over to the sick." (19 words)*
...
- This is the pool's one deliberately flat line (§25 of the pack: the plainest sentence is why the others land). One sentence, 19 words, the shortest of the twelve.
...
*Face 4 — "Whatever is put by at {settlement} against a hard year is put by behind somebody's own door, and the sick are nursed in their own beds." (25 words)*
...
*Main line — "When the food runs short the asking starts at a neighbour's door, and when somebody falls ill it is the same door. Neither has a door of its own." (29 words)*
...
- *it is the same door* — the shipped row's one genuinely good idea kept as an IDEA and not as words: the predicate is two absences under one branch, and the shared shape is the honest reading of the key.
...
*Face 2 — "What stands in for a store here is knowing which houses would say they have nothing, and what stands in for a sick-house is somebody's own room." (26 words)*
- *knowing which houses would say they have nothing* — pure silence, and the plot hook §2.8 asks for: which households are known to hold back, who is asked and who is not. Subjunctive *would*, so no rate and no event (F2-04, F2-06).
...
*Face 4 — "Somebody who falls ill here stays in the room they sleep in, and the house goes on around them. Whatever that house puts by is in the same room." (31 words)*
...
*Face 2 — "A traveller taken ill at {settlement} becomes the business of whichever roof he is under. No room is set apart for him, and he has no claim on anybody's store." (28 words)*
- *becomes the business of whichever roof he is under* — §3.8's best hook: the two absent civic objects are the two that serve a person with no household here, which is the visitor himself.
...
*Face 3 — "Every room a stranger passes at {settlement} has something in it, and not one of them is kept back against want or against a sickness." (26 words)*
