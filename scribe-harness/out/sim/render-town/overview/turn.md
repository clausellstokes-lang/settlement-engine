...
POOL "ADMINISTERED" in block DS-GEN-17
  vid: 2
  stance: visitor
...
POOL "scores.economic: STRONG" in block DS-GEN-3
  ...
  THE CORPUS LINE, as the claim and the fallback:
    ...
    notebook: none. Return an empty list.
POOL "scores.magical: WEAK" in block DS-GEN-3
  vid: 2
  stance: ledger
  THE ORDER: the corpus spine realises the move order `V1` — `PRESENT` (the state key alone); keep that order in your spine.
  slots you may use: settlement
  ...
  THE CORPUS LINE, as the claim and the fallback:
    ...
    notebook: none. Return an empty list.
POOL "foodSecurity.label: Pressured" in block DS-GEN-3
  vid: 2
  stance: street
  THE ORDER: the corpus spine realises the move order `V1` — `PRESENT` (the state key alone); keep that order in your spine.
  slots you may use: settlement
  ...
  THE CORPUS LINE, as the claim and the fallback:
    ...
    notebook: none. Return an empty list.
POOL "intensity: moderate" in block DS-GEN-2
  vid: 4
  stance: unfolding
  THE ORDER: the corpus spine realises none of the eight closed level-1 orders, so this pool sets no order for you to keep.
  slots you may use: faction, faction2, settlement, stakes
    {stakes} is "political influence" on this town
    {settlement} is "Spitzplatz" on this town
    {faction} is "The Governing Council" on this town
