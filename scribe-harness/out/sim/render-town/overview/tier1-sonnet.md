...
answer for the numbers that appear and for no others.
  POOL "MARKET-OPEN" in block DS-GEN-13, which reads:
    ...
    granted to them.
      spine: The market was where the carts already stopped; the stalls came to the stopping, and {settlement} grew around the habit.
1. (spine) The market in Spitzplatz fills the square built for it, and the trading is done in the open.
  POOL "ADMINISTERED" in block DS-GEN-17, which reads:
    ...
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
      spine: {settlement} is administered, visibly: rules here have rooms, and the rooms have officers.
2. (spine) Administration in Spitzplatz is visible. The rules here have rooms, and the rooms have officers.
  POOL "prosperity: Comfortable / Prosperous" in block DS-GEN-3, which reads:
    name = "Spitzplatz"
    {settlement} is "Spitzplatz" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
...
3. (spine) People in Spitzplatz can afford to argue about things other than money.
  POOL "economicViability.viable: true" in block DS-GEN-3, which reads:
    ...
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
      spine: There is no obvious reason {settlement} should not be here, which is a plainer compliment than it sounds.
4. (spine) There is no obvious reason Spitzplatz should not be here.
  POOL "defenseProfile.readiness.label: Well-Defended" in block DS-GEN-3, which reads:
    name = "Spitzplatz"
    {settlement} is "Spitzplatz" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
...
5. (spine) The defenses of Spitzplatz are kept properly rather than impressively. The works are sound, and none of them are for show.
  POOL "scores.military: STRONG" in block DS-GEN-3, which reads:
    ...
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
      spine: Nobody in {settlement} expects the town to lose a straight fight, and that expectation shapes how it speaks to its neighbours.
6. (spine) Nobody in Spitzplatz expects the town to lose a straight fight, and that expectation shapes how it speaks to its neighbours.
  POOL "scores.monster: STRONG" in block DS-GEN-3, which reads:
    axis = UNREADABLE BY THIS CARD (the engine decided it; the pool key states it; assert no value for this field beyond what the key says)
    readings.scores = UNREADABLE BY THIS CARD (the engine decided it; the pool key states it; assert no value for this field beyond what the key says)
    {settlement} is "Spitzplatz" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
      spine: {settlement} keeps a standing answer to the beasts of its own ground: men who know the work, and the tools kept for it.
7. (spine) Against the beasts of its own ground, Spitzplatz keeps people who know the work, and the tools kept for it.
  POOL "scores.internal: ADEQUATE" in block DS-GEN-3, which reads:
    axis = UNREADABLE BY THIS CARD (the engine decided it; the pool key states it; assert no value for this field beyond what the key says)
    readings.scores = UNREADABLE BY THIS CARD (the engine decided it; the pool key states it; assert no value for this field beyond what the key says)
    {settlement} is "Spitzplatz" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
      spine: {settlement} is orderly on the main streets and less particular about the others.
8. (spine) Spitzplatz is orderly on the main streets and less particular about the others.
  POOL "scores.economic: STRONG" in block DS-GEN-3, which reads:
    axis = UNREADABLE BY THIS CARD (the engine decided it; the pool key states it; assert no value for this field beyond what the key says)
    readings.scores = UNREADABLE BY THIS CARD (the engine decided it; the pool key states it; assert no value for this field beyond what the key says)
    {settlement} is "Spitzplatz" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
...
9. (spine) Prices in Spitzplatz are steady in a way that suggests the town is not living on the last thing that sold.
  POOL "scores.magical: WEAK" in block DS-GEN-3, which reads:
    axis = UNREADABLE BY THIS CARD (the engine decided it; the pool key states it; assert no value for this field beyond what the key says)
    readings.scores = UNREADABLE BY THIS CARD (the engine decided it; the pool key states it; assert no value for this field beyond what the key says)
    {settlement} is "Spitzplatz" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
      spine: {settlement} keeps no arrangement for the Art; when it is wanted, it is wanted from outside.
10. (spine) For the Art, Spitzplatz keeps only the alchemist's shop, and nothing more organized behind it. When more is wanted, it is wanted from outside.
  POOL "foodSecurity.label: Pressured" in block DS-GEN-3, which reads:
    name = "Spitzplatz"
    {settlement} is "Spitzplatz" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
      spine: The price of bread in {settlement} is watched, which it is not in a comfortable town.
11. (spine) The price of bread in Spitzplatz is watched closely, and a comfortable town would not need to watch it.
  POOL "intensity: moderate" in block DS-GEN-2, which reads:
    ...
    {stakes} is "political influence" on this town, and the page prints it
    {settlement} is "Spitzplatz" on this town, and the page prints it
    {faction} is "The Governing Council" on this town, and the page prints it
    {faction2} is "The Order of the Watch" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
      spine: {stakes} is what stands to change hands in {settlement}, and {faction} and {faction2} both understand that well enough to be careful with each other.
12. (spine) Political influence is what stands to change hands in Spitzplatz, and The Governing Council and The Order of the Watch both understand that well enough to be careful with each other.
  POOL "ordinary (route road and the default)" in block DS-GEN-5, which reads:
    ...
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
      spine: The road runs past {settlement} and {settlement} takes very little from it; the traffic is real and the town has stayed outside it.
13. (spine) The road runs past Spitzplatz, and the town takes very little from the traffic on it.
  POOL "road" in block DS-GEN-6, which reads:
    readings.tradeRouteAccess = UNREADABLE BY THIS CARD (the engine decided it; the pool key states it; assert no value for this field beyond what the key says)
    {settlement} is "Spitzplatz" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
...
14. (spine) What Spitzplatz cannot grow, the road brings, and the town could not do without it.
  POOL "tier overlay: other tiers" in block DS-GEN-6, which reads:
    readings.tier = UNREADABLE BY THIS CARD (the engine decided it; the pool key states it; assert no value for this field beyond what the key says)
    {settlement} is "Spitzplatz" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
      spine: {settlement} is a town, in the ordinary sense, and the ordinariness is accurate.
15. (spine) In the ordinary sense of the word, Spitzplatz is a town, and nothing here strains that word.
  POOL "prominentRelationship present" in block DS-REL-2, which reads:
    readings.prominentRelationship = UNREADABLE BY THIS CARD (the engine decided it; the pool key states it; assert no value for this field beyond what the key says)
    {settlement} is "Spitzplatz" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
      spine: One of {settlement}'s ties carries more weight than the rest, and the weight shows in what the town will and will not do.
16. (spine) One of Spitzplatz's ties carries more weight than the rest, and that weight shows in what the town does and does not do.
  POOL "flagDriven count zero" in block DS-REL-2, which reads:
    ...
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
      spine: Everyone in {settlement} is tied to everyone else for the ordinary reasons: work, family, proximity, and time.
17. (spine) Everyone in Spitzplatz is tied to everyone else for ordinary reasons, through work, family, and time.