...
1. (spine) A stranger reads Rundgate's standing off the road before anyone at the gate says a word to him. The spread of trades here keeps more hands busy than the town strictly needs, and none of it looks improvised.
...
2. (spine) No one trade carries this town, so no single reckoning of its income holds the whole of it.
...
3. (spine) The market at Rundgate carries the town's own goods and other towns' goods on the same stalls, and makes no show of telling a stranger which is which.
...
4. (spine) The yards past the gate stand full of goods waiting to go out, and no two loads are alike. The town's trade runs outward before it runs in.
...
5. (spine) Rundgate feeds itself with a small margin.
...
6. (spine) The garrison here is kept on a supply that failed somewhere upstream. The building stands, the skill remains, and the books wait.
...
7. (spine) A little of Rundgate's trade goes unrecorded... small enough to annoy the clerks who total the books, and too small to be what the town actually lives on.