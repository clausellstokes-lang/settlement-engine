...
1. (spine) The City Council governs with a modest edge, and what it asks of the town is given more often than it is refused.
...
2. (spine) The City Council is credited with the good years whether or not it made them, and the case in its favour is the trade and nothing else.
...
3. (spine) What is settled here is who answers, and not what the answer is.
...
4. (spine) Something organised here takes its share of a street or of a trade, and it has no clearer name than that.
...
5. (spine) The City Council's trouble is the town's own temper, and never a rival.
...
6. (spine) A stranger who calls the City Council by any other name is corrected at once, and politely.
...
7. (spine) Nobody who wants the City Council's place at Rundgate is within reach of it, and not one of them is quiet about wanting it.
...
8. (spine) The City Council's hold is hardened by the town's own backing. That backing turns what would be a contest in another town into an inconvenience.