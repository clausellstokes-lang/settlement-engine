...
1. (spine) The City Council is given the credit for the good years whether it earned them or not, and the good years are the whole of the case in its favour.
...
2. (spine) What is settled here is the hall and only the hall, and the steadiness is about who answers and not about the answers.
  POOL "recentConflict present" in block DS-POW-2, which reads:
...
3. (spine) The quarrel over the market levies is recent, and here it is named rather than explained.
...
4. (spine) The criminal trade here carries weight of its own, in ground held or in money moved, and nobody puts a plainer name to it.
...
5. (spine) The City Council watches the town's own temper before it watches any rival, and it knows which of the two unseats a council.
...
6. (spine) A stranger who calls the City Council by any other name is corrected politely and at once.
...
7. (spine) Everyone who wants the City Council's place is outweighed, and holding that place is not comfortable work.
...
8. (spine) The City Council's hold is hardened by the public's backing, and what would be a contest in another town is an inconvenience here.