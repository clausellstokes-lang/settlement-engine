...
THE PAGE, as the reader meets it. Question 7 is about these lines and no others:
  ...
  [machine] recentConflict: Guild Council has been debating market levies for three months. The merchants have stopped attending the sessions. Both sides are now acting as if the other has already lost.
...
answer for the numbers that appear and for no others.
  POOL "Approved" in block DS-POW-1, which reads:
    ...
    {seat} is "Guild Council" on this town, and the page prints it
...
1. (spine) The Guild Council has standing in the town, and it spends that standing on decisions the town would refuse to anybody else.
...
2. (spine) The Guild Council's standing rests on the town's prosperity, and whatever else holds it up is small beside the trade.
...
3. (spine) A stranger with business at Spitzplatz needs one name and gets one answer, and the answer holds.
...
4. (spine) The quarrel over the market levies is named in the town and never explained.
  POOL "operation role money laundering" in block DS-POW-6, which reads:
    (this pool declares no typed field)
    {settlement} is "Spitzplatz" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
...
5. (spine) Several houses of business at Spitzplatz keep books that nothing can be found wrong with, and that is the service they sell.
  POOL "mixed" in block DS-POW-5, which reads:
    (this pool declares no typed field)
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
      spine: The town cannot say in one word what kind of place it is governed as, and neither can the hall.
6. (spine) No one word in the town covers how the place is governed, and the hall cannot supply one either.
...
7. (spine) The hall is given its proper title in public and a shorter name everywhere else, and both names are exact.
  POOL "riskLabel: Holding" in block DS-POW-4, which reads:
    (this pool declares no typed field)
    {seat} is "Guild Council" on this town, and the page prints it
    {settlement} is "Spitzplatz" on this town, and the page prints it
    {faction} is "Guild Council" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
...
8. (spine) The seat the Guild Council holds is held because nothing in the town outweighs it, and that is put to the test again whenever somebody has cause.
...
9. (spine) People here who would move on the Guild Council do not, because moving on a seat the town is behind costs more than the seat is worth.