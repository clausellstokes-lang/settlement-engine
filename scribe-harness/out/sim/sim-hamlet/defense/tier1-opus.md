...
THE TOWN:
{
 ...
 "id": "s_fb778fe0fe392cd9",
 "institutions": [
  {
   "category": "economy",
   "name": "Access to external mill",
   "services": []
  },
  {
   "category": "religion",
   "name": "Access to parish church",
   "services": []
  },
  {
   "category": "religion",
 ...
 "roles": [
  ...
  },
  {
   "roster": [
    ...
    {
     "n": "pl",
     "role": "the people of the place"
    },
    {
     "n": "pl",
     "role": "the whole hamlet"
    }
   ],
   "source": "public"
  },
...
answer for the numbers that appear and for no others.
  POOL "override active, viability intact" in block DS-DEF-8, which reads:
    economicViability.viable = true
    stress = "{colour: \"#3a1a1a\", crisisHook: \"The attacks are following a pattern that suggests coordination, not desperation. Someone i (cut)\", historyColour: \"military\", icon: null, label: \"Beast & Raider Threat\", summary: \"Something in the surrounding region has grown bolder. Caravans are disappearing. A farmste (cut)\", type: \"monster_pressure\", viabilityNote: \"Trade disruption is reducing income. Defensive expenditure is increasing. Population anxie (cut)\"}"
    {settlement} is "Warmholz" on this town, and the page prints it
...
1. (spine) The crisis here has changed the town's posture and not its prospects, and the two have been kept apart on purpose.
  POOL "Invasion & War: neither walls nor force" in block DS-DEF-2, which reads:
    institutions = "[14 rows]"
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
...
2. (spine) The houses here stand with nothing around them, and nobody in the place is under arms.
9. (face 6) One of the elders says nothing here needs a wall round it, and that the households who would pay for one are the ones who say so.
...
11. (spine) No court sits here and there is nowhere to hold anyone, and what is settled is settled between households.
12. (face 0) A traveller says a short payment here is argued out on the doorstep where it was made, and a stranger who wants it heard anywhere else has nowhere to take it.
13. (face 1) The older heads here say what reaches them is settled their way, and that most of it never reaches them.
15. (face 3) A woman old enough to remember the custom says a boundary here is walked until the two households agree, and the walking comes out of work neither can spare.
  POOL "Economic Survival: WEAK" in block DS-DEF-2, which reads:
    defenseProfile.scores.economic = 21
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
...
19. (spine) What a crisis here would cost, and which households would carry it, is the question nobody in the place has settled.
20. (face 0) A rider who stopped a night says every store here is in the household's own cellar, and that a man wanting to buy food goes door to door for it.
22. (face 2) The households that keep the custom say a house with nothing else to spare finds what a burying takes, and finds it before it finds anything else.
  POOL "COMPOUND override (a crisis stress has rewritten the label)" in block DS-DEF-3, which reads:
    economicState.safetyProfile.safetyLabel = "Dangerous — Monster Threat"
    {settlement} is "Warmholz" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
...
28. (spine) The ordinary safety of Warmholz has stopped applying, and the danger from the monsters is what governs the lanes now.
...
29. (spine) The safety reading here is a first look, and it holds what has been seen and nothing of what has not.
...
30. (spine) Nothing organised is recognised behind the wrongdoing here, and what is done is done by whoever does it.
...
31. (spine) A traveller comes into the place from whichever side suits him, and meets nobody on the way in.
  POOL "NO organized force at all" in block DS-DEF-5, which reads:
    institutions = "[14 rows]"
...
32. (spine) Nobody here is answerable for the defense of the place, and a stranger who asks is given a direction and not a name.
  POOL "charter hall ABSENT where the country warrants one" in block DS-DEF-5, which reads:
    institutions = "[14 rows]"
    standingDefenseForces(settlement) = DERIVED: the engine computes this as `standingDefenseForces(settlement)`. The card holds no input for it, so give this reading no value: what the engine decided about it is what the pool key and the page lines already say.
    {settlement} is "Warmholz" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
...
33. (spine) No body here holds the defense of the place as its own charge, and the work falls on whichever households stand nearest.
...
34. (spine) Nothing here answers a threat that cannot be seen, and nothing here would know one had come.
...
35. (spine) The place is too small to wall and knows it, and what keeps it is its neighbours, its distance and its unimportance.
...
36. (spine) There is no store of food here against a bad turn. What the place eats comes up the road, and there is no other way for it to come.