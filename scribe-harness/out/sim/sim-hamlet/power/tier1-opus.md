...
1. (spine) The Free Elder Council sits as it has always sat, and almost nothing it asks of the households arrives.
...
2. (spine) A traveller who brings a question to the Free Elder Council is sent away with it, and has it settled the same afternoon by somebody here who holds no title.
  POOL "no token matched: unclassified (the plain-description floor)" in block DS-POW-2, which reads:
    (this pool declares no typed field)
3. (spine) Warmholz is governed by the Free Elder Council, and every matter of the place runs through it.
  POOL "council" in block DS-POW-5, which reads:
    (this pool declares no typed field)
4. (spine) Business before the Free Elder Council is settled slowly and by agreement, and once settled it is not readily opened again.
  POOL "governing body name: a SLOT, never a baked noun" in block DS-POW-5, which reads:
    (this pool declares no typed field)
5. (spine) People passing through who name the Free Elder Council anything else are put right at once, and politely.
...
6. (spine) The hold the Free Elder Council had here has gone to the households, and no rival was needed to take it.