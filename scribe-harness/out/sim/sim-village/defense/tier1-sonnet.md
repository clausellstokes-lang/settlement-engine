 ...
 "roles": [
  {
   "roster": [
    {
     "n": "sg",
     "role": "a woman old enough to remember the custom"
    },
    {
     "n": "sg",
     "role": "one of the elders"
    },
    {
     "n": "pl",
     "role": "the households that keep the custom"
    },
    {
     "n": "pl",
     "role": "the older heads here"
    }
   ],
   "source": "elders"
  },
  {
   "roster": [
    {
     "n": "sg",
     "role": "a buyer at the fish market"
    },
    {
     "n": "sg",
    ...
    {
     "n": "pl",
     "role": "the women who gut the catch"
    }
   ],
   "source": "market"
  },
  {
   "roster": [
    ...
    {
     "n": "pl",
     "role": "the people of the village"
    },
    {
     "n": "pl",
     "role": "the whole village"
    }
   ],
   "source": "public"
  },
  {
   "roster": [
    ...
    {
     "n": "sg",
     "role": "a woman who sings in the choir"
    },
    {
     "n": "sg",
    ...
    {
     "n": "sg",
     "role": "the chapel's warden"
    },
    {
     "n": "pl",
     "role": "the people who keep the register"
    }
   ],
   "source": "register"
  },
  ...
  },
  {
   "roster": [
    ...
    {
     "n": "pl",
     "role": "the drinkers at the alehouse"
    },
    {
     "n": "sg",
     "role": "the potboy"
...
answer for the numbers that appear and for no others.
  POOL "readiness WEAK" in block DS-DEF-1, which reads:
    defenseProfile.readiness.score = 28
    {settlement} is "Hochhausen" on this town, and the page prints it
...
1. (spine) The defensive readiness at Hochhausen is thin. Something is in place against most pressures, and nothing is held in reserve against a determined one.
  POOL "Invasion & War: neither walls nor force" in block DS-DEF-2, which reads:
    institutions = "[29 rows]"
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
...
2. (spine) Everyone in the village has watched the place go through an ordinary week with no wall around it and no one posted to keep it, and takes that as answer enough.
3. (face 0) A drover says he watched for a wall on the way in and found the road simply turning into the street with nothing to mark where one stopped and the other began.
4. (face 1) One of the elders says nobody here has ever had to say who would stand where, since nothing has come close enough to ask it of them.
5. (face 2) The stallholders say the square fills when the light comes and empties when it goes, and it is the light they answer to, not any watch.
6. (face 3) The potboy says anybody at the tavern could name the houses that would turn out if trouble came, and the naming is as far as it has ever gone.
9. (face 6) The chapel's warden holds that the people here are easier about the place than anyone passing through tends to be, and does not say which of them has it right.
  POOL "Internal Security: no legal infrastructure" in block DS-DEF-2, which reads:
    economicState.compound.inst.hasCourtSystem = false
...
12. (spine) A traveller who is wronged here learns quickly that there is no bench to bring it to, and the town is not surprised by that.
13. (face 0) A rider who stopped a night says a wrong done to him here gets settled at the door of whoever did it, there being no bench anywhere else to take it.
14. (face 1) A woman at the long table says a stranger who is owed money here does better asking for goods than waiting on coin, since no court has ever sat here to make anyone pay.
15. (face 2) The older heads here say a dispute is settled by who still has kin willing to speak for him, since no court has ever sat in the village to settle it otherwise.
16. (face 3) The chapel's warden says the parish hears a complaint the same way anyone here would, there being no court to send it to instead.
19. (face 6) A stallholder says a buyer who cheats here is simply not sold to again, and that is the only court the market has ever needed.
  POOL "Economic Survival: WEAK" in block DS-DEF-2, which reads:
    defenseProfile.scores.economic = 32
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
...
20. (spine) Everyone here has seen who turns out when the village needs a hand, and takes it that the same households would turn out again if matters were worse.
21. (face 0) A messenger off the road says what is put into his hand here is goods more often than coin, and no one troubles to explain why.
22. (face 1) One of the elders says a call for help here is made out loud and in front of the neighbours, so that a refusal is heard by the same ears as the asking.
23. (face 2) A woman at the long table says the loudest talkers here are the last ones asked to help, and the ones asked first say little over their cups.
24. (face 3) One of the congregation says a household gives toward a burying whatever it can spare, and the neighbours remember the giving better than any count would.
27. (face 6) The market clerk says the place takes from whoever can be found on a given day, and a stall is the easiest thing there is to find.
  POOL "Disasters & Famine: NO reserves, NO medical provision" in block DS-DEF-2, which reads:
    economicState.compound.inst.hasChurch = true
    economicState.compound.inst.hasGranary = false
...
30. (spine) A traveller who asks here where the grain is kept is pointed at a field, and one who asks for a house for the sick is pointed at somebody's door.
31. (face 0) A pilgrim says he asked after a grain store here and was shown a field instead, there being nowhere built to hold what comes in.
32. (face 1) The potboy says a stranger who asks after a sick house here is taken for sick himself and given a seat by the door.
33. (face 2) The older heads here say what a stranger calls a want is only how the place has always been arranged, and they do not say who arranged it that way.
34. (face 3) The chapel's warden says part of the burying ground digs easy and part does not, and everyone here already knows which part is which.
35. (face 4) A stallholder says a buyer can get grain here on a market day and nowhere at all to keep it afterward.
...
36. (spine) Enforcement and criminal presence at Hochhausen sit close enough that the town's condition rests on which way the next few seasons run.
...
37. (spine) The safety reading for Hochhausen is a first one. It is plain about what has been seen so far and silent on what has not.
  POOL "structure null (nothing organized recognized)" in block DS-DEF-4, which reads:
    structureKey = UNREADABLE BY THIS CARD (the engine decided it; the pool key states it; assert no value for this field beyond what the key says) — a CALLER'S ARGUMENT and not a settlement field — `defenseCriminalProse(settlement, structureKey, options)` takes it from `deriveCriminalStructure(settlement).key`, which the page prints beside the pool as the criminal-structure badge
    {settlement} is "Hochhausen" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
...
38. (spine) A traveller who asks after any organized crime in Hochhausen meets a plain blank look, and whether that look is honest or well performed is not something the traveller can settle.
  POOL "walls ABSENT" in block DS-DEF-5, which reads:
    institutions = "[29 rows]"
    {settlement} is "Hochhausen" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
...
39. (spine) Hochhausen has an edge rather than a boundary, and the edge falls wherever the last house happens to stand.
...
40. (spine) A traveller in Hochhausen finds a hall whose business is the kind of trouble no garrison would know what to do with, and finds it doing steady work.
  POOL "arcane defense ABSENT" in block DS-DEF-5, which reads:
...
41. (spine) The town has no answer to a threat it cannot see, and stands unprepared rather than shielded against that kind of danger.
  POOL "UNWALLED-SMALL" in block DS-DEF-11, which reads:
    institutions = "[29 rows]"
    {settlement} is "Hochhausen" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
...
42. (spine) No wall marks where Hochhausen ends. At this size the country and the town simply agree to differ.
  POOL "Logistics & Supply: No reserves, landlocked" in block DS-DEF-6, which reads:
...
43. (spine) The town eats what the road brings in, and keeps nothing put by for a season when the road brings less.