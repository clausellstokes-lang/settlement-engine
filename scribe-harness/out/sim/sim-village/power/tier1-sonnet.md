...
answer for the numbers that appear and for no others.
  POOL "Tolerated" in block DS-POW-1, which reads:
    (this pool declares no typed field)
    {seat} is "Elected Reeve" on this town, and the page prints it
...
1. (spine) The Elected Reeve at Hochhausen has neither the town's backing nor its hostility, and rules without the means to spend on anything hard.
...
2. (spine) At Hochhausen the Elected Reeve is well thought of, since the town is doing well, and a town doing well rarely looks hard at who is arranging it.
  POOL "stable matched" in block DS-POW-2, which reads:
    (this pool declares no typed field)
    {settlement} is "Hochhausen" on this town, and the page prints it
    {faction} is "Elected Reeve" on this town, and the page prints it
    {faction} is "Elected Reeve" on this town, and the page prints it
    THE HAND-WRITTEN LINE THIS POOL SHIPS. It is not a line to judge: it is the claim, it ships
    on this page if the lines below are refused, and a record, an office or a body IT names is
    granted to them.
...
3. (spine) The seat at Hochhausen is settled, and the town conducts its business on the plain expectation that the Elected Reeve, who holds it now, goes on holding it.
...
4. (spine) Nothing at Hochhausen governs cleanly, since the Elected Reeve is an arrangement between kinds of power that decides at the pace of whichever of them is least willing.
...
5. (spine) The governing body at Hochhausen calls itself the Elected Reeve, and the name is exact about both the town's size and its pretensions, in a way a stranger usually misses.
...
6. (spine) Hochhausen has people who would take charge if they could, and they cannot, and both sides know precisely where that leaves them.
  POOL "legitimacyHold: public opinion neither helps nor hurts" in block DS-POW-4, which reads:
...
7. (spine) Public feeling at Hochhausen tilts neither toward the Elected Reeve nor against it, and the Elected Reeve governs on nothing but its own strength.