...
1. (spine) The roads in are busy and the place at the end of them is poor.
...
2. (spine) One trade brings in the money here, and every other living comes out of it.
...
3. (spine) Goods leave this place and goods come into it on the same carts.
...
4. (spine) Warmholz sells several things outward and leans on none of them alone.
  POOL "SECURE" in block DS-ECO-9, which reads:
    (this pool declares no typed field)
5. (spine) The place feeds itself and keeps a little in hand.
...
6. (spine) Salt is worked here, and all of it is bought before it is worked.