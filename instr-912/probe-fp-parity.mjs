...
import { fingerprint, RATE_METRICS } from '../laneINSTR/src/domain/prose/proseFingerprint.js';
...
process.env.FP_OUT = '/tmp/kit-fp.json';
execFileSync('node',[K+'/fingerprint.mjs','parity',file],{cwd:'/tmp',stdio:'ignore',env:{...process.env,FP_OUT:'/tmp/kit-fp.json'}});
const kit = JSON.parse(readFileSync('/tmp/kit-fp.json','utf8'));
