...
Use the current working directory opened in Codex. A typical structure:
...
## Codex Preview verification

Codex Preview can throttle animation when backgrounded. If screenshots look
