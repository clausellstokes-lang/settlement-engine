 ...
 * an edge function.
 *
 * This scans every migration + edge function for a bare email literal appearing
 * near an auth/role/privilege keyword. It deliberately does NOT scan src/ UI
 * files: a `mailto:` support-contact link is a product choice, not a trust
 * boundary. If a legitimate future need arises, use an env var, not a literal.
 */
