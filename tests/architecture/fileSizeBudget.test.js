...
const GRANDFATHERED = {
  ...
  'src/domain/worldPulse/warDeployment.js': 1492, // defender-attrition + war-economy P1 + defender-resolve P4 + ally-defense P3 + sack/forage P3 + shared composeDefenderWillScore (reused by the War & Resolve display)
