 ...
 * label, AND click destination. A VIOLET reason is an upgrade (purchase modal);
...
describe('PricingMomentCard — anon signup/unlock routing (#16)', () => {
  test('a GOLD signup/unlock moment opens SIGN-IN, never the buy-wall', () => {
    mount('signup_unlock'); // not in VIOLET_REASONS ⇒ gold
  ...
  test('a VIOLET upgrade moment opens the purchase modal, not sign-in', () => {
    mount('third_save'); // in VIOLET_REASONS ⇒ violet/upgrade
