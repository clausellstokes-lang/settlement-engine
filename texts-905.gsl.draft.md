...
- **(b) certification, seven presets through `--preset` (5 years × 4 settlements, `--seed lprobe-<id>`):** seam HOLDS 7/7 (composed
  ...
  91 rows. Bracketing the lit default: ⟦BRACKET-902⟧ at `fd36f0298` → ⟦BRACKET-903⟧ at `dd5f13218`. (The L-OVERLAY receipt's 09-05
  figure at the §899 tip was 8 / 13 / 3 / 62 of 86 rows; the roster grew 86 → 91 between §899 and §904 — ⟦ROSTER-GROWTH⟧.)
