...
var PRE_T8_CORRUPTION_SCORE = Object.freeze({
  subsistence: 0,
  destitute: 0,
  poor: 0.2,
  struggling: 0.2,
...
var TEMPER_WORDS = Object.freeze(["warlike", "peacelike", "neutral"]);
...
// src/domain/worldPulse/cultImpositionApply.js
var SLOTS_BY_TIER = Object.freeze({ thorp: 1, hamlet: 2, village: 2, town: 3, city: 5, metropolis: 7 });
var DEITY_RANK_STRENGTH = Object.freeze({ major: 0.95, minor: 0.6, cult: 0.35 });

// src/domain/worldPulse/faithTuningSurface.js
var FAITH_TUNING_SIGNATURE = Object.freeze({ signed: false, live: false });
var FAITH_TUNING_PROVENANCE = Object.freeze({
...
var FAITH_FIELD_TUNING = Object.freeze({
...
var DEITY_FLAW_TUNING = Object.freeze({
...
var FAITH_WITNESS_TUNING = Object.freeze({
  ...
  // lesson lands.
  FULL_EXPOSURE: 0.6,
  // ≥ this: the lesson lands at the authored level
  PART_EXPOSURE: 0.25
  // ≥ this: one rung down
...
var FAITH_TUNING_COVERAGE = Object.freeze([
...
var DEITY_FLAW_PROVENANCE = Object.freeze({
...
var DEITY_FLAW_LEVELS = Object.freeze(["a_touch", "marked", "defining"]);
var DEITY_FLAWS = Object.freeze([
  Object.freeze({
    word: "jealous",
    axisId: "CONTENT",
    mappedTo: "envious",
...
var FLAW_EFFECTS = Object.freeze({
...
var FAITH_CHANNELS = Object.freeze([
  "harvest",
  "trade",
  "craft",
  "healing",
...
var FAITH_STRENGTHS = Object.freeze(["faint", "firm", "heavy"]);
...
var FAITH_UNBOUND_CHANNELS = Object.freeze({
...
var BOON_FLAW = Object.values(FLAW_EFFECTS).find((e) => e.modulates === "boon_term")?.flaw ?? "";
