...
var TERM_CATALOG = Object.freeze({
  ...
  sovereignty_transfer: Object.freeze({ family: "sovereignty_transfer", weight: 2, baseYears: 10, maxYears: 25, baseMag: 1, stream: false, executor: "seam" }),
  ...
  shared_rite: Object.freeze({ family: "faith", weight: 0.4, baseYears: 6, maxYears: 15, baseMag: 1, stream: false, executor: "grant" }),
  ...
  pilgrimage_right: Object.freeze({ family: "faith", weight: 0.5, baseYears: 5, maxYears: 12, baseMag: 1, stream: false, executor: "grant" }),
  ...
  tolerance_guarantee: Object.freeze({ family: "faith", weight: 0.6, baseYears: 8, maxYears: 20, baseMag: 1, stream: false, executor: "grant" }),
  ...
  missionary_access: Object.freeze({ family: "faith", weight: 0.8, baseYears: 4, maxYears: 10, baseMag: 1, stream: false, executor: "grant" }),
  ...
  migration_right: Object.freeze({ family: "population", weight: 0.6, baseYears: 5, maxYears: 12, baseMag: 1, stream: false, executor: "grant" }),
  labor_compact: Object.freeze({ family: "population", weight: 0.8, baseYears: 4, maxYears: 10, baseMag: 1, stream: false, executor: "grant" }),
  ...
  settlement_provision: Object.freeze({ family: "population", weight: 1, baseYears: 3, maxYears: 8, baseMag: 0.3, stream: true, executor: "transfer" }),
  ...
  mutual_defense: Object.freeze({ family: "security", weight: 1, baseYears: 8, maxYears: 20, baseMag: 1, stream: false, executor: "grant" }),
  ...
  exclusivity: Object.freeze({ family: "commercial", weight: 1, baseYears: 4, maxYears: 10, baseMag: 1, stream: false, executor: "seam" }),
  market_access: Object.freeze({ family: "commercial", weight: 0.7, baseYears: 5, maxYears: 12, baseMag: 1, stream: false, executor: "seam" }),
  toll_exemption: Object.freeze({ family: "commercial", weight: 0.5, baseYears: 4, maxYears: 10, baseMag: 1, stream: false, executor: "seam" })
});
...
var TERM_EXECUTORS = Object.freeze([
  "grant",
  "occupation_hold",
  "overlay",
  "readiness_cap",
...
var ENVOY_PURPOSE_CLASSES = Object.freeze([
  "commercial",
  "covert",
  "diplomatic",
  "factional",
...
var PURPOSE_CLASS_BY_PURPOSE = Object.freeze({
  self_parlay: "diplomatic",
  sue: "diplomatic"
});
var ENVOY_COVERT_PRODUCTS = Object.freeze(["acquire", "confirm", "refute"]);
var ENVOY_COVERT_DEMANDS = Object.freeze(["certain", "confirm", "corroborate"]);
var ENVOY_COVERT_FACES = Object.freeze(["covert", "declared"]);
var ENVOY_COVERT_LEG_REFS = Object.freeze([
  "exports",
  "readiness",
  "routePositionBand",
  "storesBand",
...
var MAX_COVERT_ITINERARY_STOPS = 3;
var COVERT_STOP_KEYS = Object.freeze(["face", "settlementId", "stayTicks"]);
var ENVOY_COVERT_TAPS = Object.freeze(["beliefs", "delta", "performance"]);
var MAX_COVERT_DWELL_RESAMPLES = 6;
var MAX_COVERT_GATHERED = MAX_COVERT_ITINERARY_STOPS * (1 + MAX_COVERT_DWELL_RESAMPLES);
var COVERT_GATHERED_KEYS = Object.freeze(["accuracyCap01", "atTick", "subjectId", "tap"]);
var COVERT_GATHERED_SENT_KEYS = Object.freeze([...COVERT_GATHERED_KEYS, "sentHome"]);
var COVERT_KEYS = Object.freeze([
  "demand",
  "gathered",
  "itinerary",
  "legRefs",
...
var ERRAND_CONSUMERS = Object.freeze([
  Object.freeze({
    consumer: "envoys",
...
var PURPOSE_CLASS_SET = new Set(ENVOY_PURPOSE_CLASSES);
var COVERT_PRODUCT_SET = new Set(ENVOY_COVERT_PRODUCTS);
var COVERT_DEMAND_SET = new Set(ENVOY_COVERT_DEMANDS);
var COVERT_FACE_SET = new Set(ENVOY_COVERT_FACES);
var COVERT_LEG_REF_SET = new Set(ENVOY_COVERT_LEG_REFS);
var COVERT_TAP_SET = new Set(ENVOY_COVERT_TAPS);
