...
// ../slot-2/node_modules/seedrandom/lib/alea.js
var require_alea = __commonJS({
  "../slot-2/node_modules/seedrandom/lib/alea.js"(exports, module) {
...
// ../slot-2/node_modules/seedrandom/lib/xor128.js
var require_xor128 = __commonJS({
  "../slot-2/node_modules/seedrandom/lib/xor128.js"(exports, module) {
    (function(global, module2, define2) {
...
// ../slot-2/node_modules/seedrandom/lib/xorwow.js
var require_xorwow = __commonJS({
  "../slot-2/node_modules/seedrandom/lib/xorwow.js"(exports, module) {
    (function(global, module2, define2) {
      function XorGen(seed) {
        var me = this, strseed = "";
        me.next = function() {
...
// ../slot-2/node_modules/seedrandom/lib/xorshift7.js
var require_xorshift7 = __commonJS({
  "../slot-2/node_modules/seedrandom/lib/xorshift7.js"(exports, module) {
    (function(global, module2, define2) {
      function XorGen(seed) {
        var me = this;
        me.next = function() {
...
// ../slot-2/node_modules/seedrandom/lib/xor4096.js
var require_xor4096 = __commonJS({
  "../slot-2/node_modules/seedrandom/lib/xor4096.js"(exports, module) {
    (function(global, module2, define2) {
      function XorGen(seed) {
        var me = this;
        me.next = function() {
...
// ../slot-2/node_modules/seedrandom/lib/tychei.js
var require_tychei = __commonJS({
  "../slot-2/node_modules/seedrandom/lib/tychei.js"(exports, module) {
    (function(global, module2, define2) {
      function XorGen(seed) {
        var me = this, strseed = "";
        me.next = function() {
...
// ../slot-2/node_modules/seedrandom/seedrandom.js
var require_seedrandom = __commonJS({
  "../slot-2/node_modules/seedrandom/seedrandom.js"(exports, module) {
...
// ../slot-2/node_modules/seedrandom/index.js
var require_seedrandom2 = __commonJS({
  "../slot-2/node_modules/seedrandom/index.js"(exports, module) {
    ...
    },
    {
      ...
      "fields": [
        ...
        },
        {
          ...
          "effect": "mechanical",
          "activation": "conditional",
          "condition": "The settlement causal channel this deity blesses. Pairs with boonStrength; both or neither. MECHANICAL at W-FAITH F4c (ODQ 851): the pulse projects the influence field onto config.faithProfile.field at tick END; causalState reads it at the next tick's start and pushes one signed contributor onto the bound causal variable. Six channels bind to a real causal variable (harvest, trade, craft, healing, order, war_readiness); sea, learning and hearth name no settlement causal quantity anywhere in src/domain and are DECLARED UNBOUND in faithField.FAITH_UNBOUND_CHANNELS, which carries each measurement and is enforced by faithChannelWiring.test.js — authored there they mint no projected key and move no score. A deity carrying an authored boon or bane silences its legacy `domain` arm (one arm per deity), so the two can never both price one quantity. DORMANT BY ABSENCE today: no deity authors either, so no field key is minted and the substrate is byte-identical.",
          "consumers": [
            "causalState",
            "deitySnapshot",
            "dispositionProfile",
          ...
          "effectKind": "mechanical",
          "activationMode": "conditional",
          "explanation": "The settlement causal channel this deity blesses. Pairs with boonStrength; both or neither. MECHANICAL at W-FAITH F4c (ODQ 851): the pulse projects the influence field onto config.faithProfile.field at tick END; causalState reads it at the next tick's start and pushes one signed contributor onto the bound causal variable. Six channels bind to a real causal variable (harvest, trade, craft, healing, order, war_readiness); sea, learning and hearth name no settlement causal quantity anywhere in src/domain and are DECLARED UNBOUND in faithField.FAITH_UNBOUND_CHANNELS, which carries each measurement and is enforced by faithChannelWiring.test.js — authored there they mint no projected key and move no score. A deity carrying an authored boon or bane silences its legacy `domain` arm (one arm per deity), so the two can never both price one quantity. DORMANT BY ABSENCE today: no deity authors either, so no field key is minted and the substrate is byte-identical."
        },
        {
          "type": "enum",
          "values": [
          ...
          "effect": "mechanical",
          "activation": "conditional",
          "condition": "The banded magnitude of the boon (faint/firm/heavy), never a float; at full patron weight the three bands are worth 2, 4 and 8 score points. MECHANICAL at W-FAITH F4c (ODQ 851): the pulse projects the influence field onto config.faithProfile.field at tick END; causalState reads it at the next tick's start and pushes one signed contributor onto the bound causal variable. Six channels bind to a real causal variable (harvest, trade, craft, healing, order, war_readiness); sea, learning and hearth name no settlement causal quantity anywhere in src/domain and are DECLARED UNBOUND in faithField.FAITH_UNBOUND_CHANNELS, which carries each measurement and is enforced by faithChannelWiring.test.js — authored there they mint no projected key and move no score. A deity carrying an authored boon or bane silences its legacy `domain` arm (one arm per deity), so the two can never both price one quantity. DORMANT BY ABSENCE today: no deity authors either, so no field key is minted and the substrate is byte-identical.",
          "consumers": [
            "causalState",
            "deitySnapshot",
            "faithField",
          ...
          "effectKind": "mechanical",
          "activationMode": "conditional",
          "explanation": "The banded magnitude of the boon (faint/firm/heavy), never a float; at full patron weight the three bands are worth 2, 4 and 8 score points. MECHANICAL at W-FAITH F4c (ODQ 851): the pulse projects the influence field onto config.faithProfile.field at tick END; causalState reads it at the next tick's start and pushes one signed contributor onto the bound causal variable. Six channels bind to a real causal variable (harvest, trade, craft, healing, order, war_readiness); sea, learning and hearth name no settlement causal quantity anywhere in src/domain and are DECLARED UNBOUND in faithField.FAITH_UNBOUND_CHANNELS, which carries each measurement and is enforced by faithChannelWiring.test.js — authored there they mint no projected key and move no score. A deity carrying an authored boon or bane silences its legacy `domain` arm (one arm per deity), so the two can never both price one quantity. DORMANT BY ABSENCE today: no deity authors either, so no field key is minted and the substrate is byte-identical."
        },
        {
          "type": "enum",
          "values": [
          ...
          "effect": "mechanical",
          "activation": "conditional",
          "condition": "The settlement causal channel this deity blights. Pairs with baneStrength; both or neither. MECHANICAL at W-FAITH F4c (ODQ 851): the pulse projects the influence field onto config.faithProfile.field at tick END; causalState reads it at the next tick's start and pushes one signed contributor onto the bound causal variable. Six channels bind to a real causal variable (harvest, trade, craft, healing, order, war_readiness); sea, learning and hearth name no settlement causal quantity anywhere in src/domain and are DECLARED UNBOUND in faithField.FAITH_UNBOUND_CHANNELS, which carries each measurement and is enforced by faithChannelWiring.test.js — authored there they mint no projected key and move no score. A deity carrying an authored boon or bane silences its legacy `domain` arm (one arm per deity), so the two can never both price one quantity. DORMANT BY ABSENCE today: no deity authors either, so no field key is minted and the substrate is byte-identical.",
          "consumers": [
            "causalState",
            "deitySnapshot",
            "dispositionProfile",
          ...
          "effectKind": "mechanical",
          "activationMode": "conditional",
          "explanation": "The settlement causal channel this deity blights. Pairs with baneStrength; both or neither. MECHANICAL at W-FAITH F4c (ODQ 851): the pulse projects the influence field onto config.faithProfile.field at tick END; causalState reads it at the next tick's start and pushes one signed contributor onto the bound causal variable. Six channels bind to a real causal variable (harvest, trade, craft, healing, order, war_readiness); sea, learning and hearth name no settlement causal quantity anywhere in src/domain and are DECLARED UNBOUND in faithField.FAITH_UNBOUND_CHANNELS, which carries each measurement and is enforced by faithChannelWiring.test.js — authored there they mint no projected key and move no score. A deity carrying an authored boon or bane silences its legacy `domain` arm (one arm per deity), so the two can never both price one quantity. DORMANT BY ABSENCE today: no deity authors either, so no field key is minted and the substrate is byte-identical."
        },
        {
          "type": "enum",
          "values": [
          ...
          "effect": "mechanical",
          "activation": "conditional",
          "condition": "The banded magnitude of the bane (faint/firm/heavy), never a float; at full patron weight the three bands subtract 2, 4 and 8 score points. MECHANICAL at W-FAITH F4c (ODQ 851): the pulse projects the influence field onto config.faithProfile.field at tick END; causalState reads it at the next tick's start and pushes one signed contributor onto the bound causal variable. Six channels bind to a real causal variable (harvest, trade, craft, healing, order, war_readiness); sea, learning and hearth name no settlement causal quantity anywhere in src/domain and are DECLARED UNBOUND in faithField.FAITH_UNBOUND_CHANNELS, which carries each measurement and is enforced by faithChannelWiring.test.js — authored there they mint no projected key and move no score. A deity carrying an authored boon or bane silences its legacy `domain` arm (one arm per deity), so the two can never both price one quantity. DORMANT BY ABSENCE today: no deity authors either, so no field key is minted and the substrate is byte-identical.",
          "consumers": [
            "causalState",
            "deitySnapshot",
            "faithField",
          ...
          "effectKind": "mechanical",
          "activationMode": "conditional",
          "explanation": "The banded magnitude of the bane (faint/firm/heavy), never a float; at full patron weight the three bands subtract 2, 4 and 8 score points. MECHANICAL at W-FAITH F4c (ODQ 851): the pulse projects the influence field onto config.faithProfile.field at tick END; causalState reads it at the next tick's start and pushes one signed contributor onto the bound causal variable. Six channels bind to a real causal variable (harvest, trade, craft, healing, order, war_readiness); sea, learning and hearth name no settlement causal quantity anywhere in src/domain and are DECLARED UNBOUND in faithField.FAITH_UNBOUND_CHANNELS, which carries each measurement and is enforced by faithChannelWiring.test.js — authored there they mint no projected key and move no score. A deity carrying an authored boon or bane silences its legacy `domain` arm (one arm per deity), so the two can never both price one quantity. DORMANT BY ABSENCE today: no deity authors either, so no field key is minted and the substrate is byte-identical."
        }
      ],
      "dependencies": []
    },
...
var RESTORE_CONTENT_SOURCE_TYPES = Object.freeze(["account-export"]);
...
var SEED_ALPHABET = "0123456789abcdefghijklmnopqrstuvwxyz";
var SEED_ENTROPY_LEN = 6;
var SEED_SEQUENCE_LEN = 3;
var SEED_SUFFIX_LEN = SEED_SEQUENCE_LEN + SEED_ENTROPY_LEN;
var SEED_SEQUENCE_CEILING = Array.from(
...
var RELATIONSHIP_PLANE_ALIASES = Object.freeze({
  trade: "trade_partner",
  alliance: "allied",
  ally: "allied",
  war: "hostile",
...
// src/domain/instantWorld/genesisDiplomacy.js
var GENESIS_SELECTIONS = Object.freeze(RELATIONSHIP_SELECTIONS.map((s) => s.value));
var GENESIS_RELATION_CAUSES = Object.freeze({
...
var GENESIS_CAUSE_TOKENS = Object.freeze(Object.keys(GENESIS_RELATION_CAUSES));
...
function arcaneNameFallback(text, vocabulary = {}) {
...
function resolveArcaneIdentity(catalogTag, text, vocabulary) {
...
var PROSPERITY_LABELS = Object.freeze([
  "Struggling",
  "Poor",
  "Moderate",
  "Comfortable",
...
var PROSPERITY_RANK = Object.freeze({
  // ── The emitted six ──
  Struggling: 0.1,
  Poor: 0.25,
  Moderate: 0.5,
...
var FOLDED = Object.freeze(Object.fromEntries(
  Object.entries(PROSPERITY_RANK).map(([label, rank]) => [label.toLowerCase(), rank])
));
var FOLDED_BY_LENGTH = Object.freeze(
...
var CORRUPTION_VECTORS = Object.freeze([...new Set(Object.values(FLAW_VECTOR))].sort());
  ...
  town: {
    ...
    Crafts: {
      ...
      Tanners: {
        ...
        baseChance: 0.7,
        desc: "Leather production. Foul-smelling; sited by water and toward the settlement edge where the ground allows.",
        tags: ["leather"],
        priorityCategory: "crafts"
      },
      "Butchers (3-8)": {
  ...
  city: {
    ...
    Criminal: {
      ...
      "Kidnapping ring": {
        ...
        desc: "Targets free persons for fraudulent insertion into slavery through forged provenance documents. Where no lawful market exists to absorb the traffic, it runs its own holding, its own escorts, and its own silence.",
        tags: ["criminal", "underground"],
        priorityCategory: "criminal"
      },
    ...
    Exotic: {
      ...
      "Airship docking (high magic)": {
        ...
        minTier: "metropolis",
        baseChance: 0.1,
        desc: "Mooring towers with magical weather protection.",
        tags: ["arcane", "exotic"],
        magicLicense: "high",
        priorityCategory: "exotic"
      },
...
// src/domain/arcaneInstitutionVocabulary.js
var ARCANE_INST_TAGS = ["arcane", "planar", "enchanting"];
var TRADE_INST_TAGS = ["alchemy"];
...
var CATEGORY_INSTITUTION_HINTS = Object.freeze({
  ...
  // WORD-ANCHORED, and TWINNED with the criminal row in the other hint table: bare `den` matched Resi-den-t / War-den-s. Both copies are pinned byte-equal in tests/domain/npcProfile.test.js.
...
var MAGIC_LICENCE_LEVELS = Object.freeze(["none", "low", "medium", "high"]);
...
var BURIAL_INSTITUTION_PATTERN = /(graveyard|burial|cemeter|charnel|ossuar)/i;
...
var FAITH_CHANNEL_BINDINGS = Object.freeze({
...
var CAUSAL_SWING = 20;
function faithChannelTotalOf(field, channel) {
  const raw = field?.channels?.[channel];
  return typeof raw === "number" && Number.isFinite(raw) ? raw : 0;
}
function faithChannelLift(field, channel) {
...
function pietyLocalAmp(s) {
  const cfg = (
    /** @type {{ faithProfile?: { piety?: { localMult?: number, dampener?: { megaphoneLaw?: number } }, field?: { channels?: Record<string, unknown> } } } | undefined} */
    /** @type {unknown} */
    s?.config
  );
...
function deriveHealingCapacity(s) {
  ...
  if (healers >= 3) {
    ...
    score -= 2;
    push(contributors, "availableServices.healing", "services_only", -2, `${heal.careServices.length} healing service(s) offered, but no dedicated institution.`);
  } else {
    score -= 10;
...
function tokensOf(value) {
  return comparable(value).split(" ").filter((t) => t.length > 2 && !TOKEN_STOPWORDS.has(t));
}
...
// src/domain/display/warStatus.js
var WAR_EXHAUSTION_WORDS = Object.freeze({
  rested: "rested",
  near_peace: "near peace",
  war_weary: "war-weary",
  exhausted: "exhausted"
});
var WAR_EXHAUSTION_BAND_KEYS = Object.freeze(Object.keys(WAR_EXHAUSTION_WORDS));
...
var STATUS_IMPAIRED = "impaired";
var STATUS_REMOVED = "removed";
var STATUS_DESTROYED = "destroyed";
var STATUS_VACANT = "vacant";
var ENTITY_STATUS_VALUES = Object.freeze([
  STATUS_ACTIVE,
  STATUS_IMPAIRED,
  STATUS_REMOVED,
  STATUS_DESTROYED,
...
var ENGINE_GATED_VIRTUAL_RULE_KEYS = Object.freeze([
...
function deriveDormantRuleKeys(register, defaults, presets) {
...
var ENGINE_GATED_DORMANT_RULE_KEYS = Object.freeze(
...
// src/domain/worldPulse/relationshipState.js
var RELATION_LEVEL_WORDS = Object.freeze(["faint", "moderate", "strong", "near-total"]);

// src/domain/worldPulse/concludedWarRecord.js
var CLOSE_ROADS = Object.freeze([
  "attacker_lost",
  "authority_verdict",
  "conquest",
  "convoy_lost_debark",
...
var CLOSE_ROAD_SET = new Set(CLOSE_ROADS);
var PARTICIPANT_SIDES = Object.freeze([
  "attacker",
  "attacker_ally",
  "defender",
  "defender_ally"
]);
var PARTICIPANT_SIDE_SET = new Set(PARTICIPANT_SIDES);
var CONCLUDED_WAR_FORMS = Object.freeze(["full", "epitome"]);
var FORM_SET = new Set(CONCLUDED_WAR_FORMS);
var TERRITORIAL_OUTCOME_KINDS = Object.freeze(["occupied", "razed"]);
var TERRITORIAL_KIND_SET = new Set(TERRITORIAL_OUTCOME_KINDS);
...
var HALF_LIFE_BANDS = Object.freeze([
  "a_season",
  "a_year",
  "a_few_years",
  "a_decade",
...
var HALF_LIFE_WEEKS = Object.freeze({
  a_season: INTERVAL_WEEKS.one_season,
  // 13 — a rumour's warmth
  a_year: INTERVAL_WEEKS.one_year,
  // 52 — a season's grudge, a reputation
  a_few_years: 3 * INTERVAL_WEEKS.one_year,
  // 156 — a bond, a standing, a grudge
  a_decade: 10 * INTERVAL_WEEKS.one_year,
  // 520 — a scar on the fabric
  a_generation: 20 * INTERVAL_WEEKS.one_year
  // 1040 — what a people remembers
});
var CROSSING_DIRECTIONS = Object.freeze(["rose", "fell"]);
...
var APPETITE_STOCK_KIND = "court_risk_appetite";
var APPETITE_BAND_LADDER = Object.freeze(CHANNEL_BANDS.map((band) => band.name));
var APPETITE_HALF_LIFE_BAND = "a_few_years";
var APPETITE_LESSON_FAMILIES = Object.freeze({
...
var APPETITE_SILENT_SOURCE_KINDS = Object.freeze(["resolved_outcome"]);
var APPETITE_LEARN_RATES = Object.freeze({ war: 0.11, covenant: 0.06, venture: 0.08 });
var APPETITE_LESSON_OF = (
  /** @type {Readonly<Record<string, string>>} */
  Object.freeze(
    Object.fromEntries(
      Object.entries(APPETITE_LESSON_FAMILIES).flatMap(([family, kinds]) => kinds.map((kind) => [kind, family]))
    )
  )
);
...
var APPETITE_TUNING = Object.freeze({
  NEUTRAL_STOCK01,
...
var NPC_ALIGNMENT_LABELS = Object.freeze({
...
// src/kernel/detPow.js
var LOG2E2 = 1.4426950408889634;
var LN22 = 0.6931471805599453;
var SQRT22 = 1.4142135623730951;
function log2Det2(x) {
  let e = 0;
  let m = x;
  while (m >= 2) {
...
var __internals2 = Object.freeze({ log2Det: log2Det2, exp2Det });

// src/domain/entities/npcs.js
var NPC_UNAVAILABLE_STATUSES = Object.freeze(["dead", "exiled", "jailed", "removed"]);
var NPC_STATUS_VALUES = Object.freeze(["active", "dead", "exiled", "jailed", "missing", "removed", "retired"]);
...
var OFF_STAGE_STATUSES = Object.freeze(
...
var DISPLAY_LEXICON = Object.freeze({
...
var INCIDENT_DISCLOSURE = Object.freeze({
...
var INCIDENT_FAMILIES = Object.freeze([
  Object.freeze({
    ...
    phrase: (tail) => `The pressure they shared ended: ${tail}`
  }),
  Object.freeze({
    id: "canon-event",
    prefix: "canon_",
    ...
    phrase: (tail) => `Something you wrote into the world touched them: ${tail}`
  })
]);
...
var TRAVELLER_KINDS = Object.freeze(["army", "caravan", "covert_envoy", "smuggler", "wanderer"]);
var HIDDEN_PATH_KINDS = Object.freeze(["covert_envoy", "smuggler", "wanderer"]);
...
var CRISIS_MORTALITY_WEIGHTS = Object.freeze({
  food: 0.65,
  disease: 1,
  war: 0.8,
  burden: 0.3
});
var CRISIS_ARCHETYPE_CLASSES = Object.freeze({
  famine: "food",
...
var CRISIS_SYSTEM_CLASSES = Object.freeze({
  food_security: "food",
...
var DEMOGRAPHIC_TUNING_SIGNATURE = Object.freeze({ signed: false, lit: null });
var DEMOGRAPHIC_TUNING_PROVENANCE = Object.freeze({
  status: "CANDIDATE, OWNER-UNSIGNED (wave P landed the values as the lane's claim, not the owner's word)",
  signedBy: null,
  odqRow: null,
  signedOn: null,
  ritual: "To light: the lighting wave flips demographicsEnabled in every shipped preset and writes lit {odqRow, litOn, presets} here in the same commit, as a declared shift. To sign: set signed true and write signedBy, odqRow and signedOn here in one diff at the tuning sitting. The register walker refuses a lit preset with no lighting record.",
  coverage: "DEMOGRAPHIC_TUNING_COVERAGE below is the roster: every frozen numeric export of the demographic family, plus the one congestion dial the family reads from the legacy migration lane, plus the eight closed vocabularies the receipt and the reading speak."
});
var DEMOGRAPHIC_TUNING_COVERAGE = Object.freeze(
  ...
  [
    ...
    Object.freeze({
      ...
      unit: "fraction01",
      note: "How much of a hub's richness gravity saturation takes away. It is rostered here because the lit demographic bound becomes its pressure denominator, so signing the bound without re-reading this dial signs half a coupling. ⚠ HOME CORRECTED BY MEASUREMENT: the design volume homes this dial at migrationKernel.js#MIGRATION_KERNEL_TUNING.CONGEST_DECAY, and no such export exists at any tip. The value 0.85 lives here, and the citation is fixed rather than copied."
    }),
...
function renderContentVocabulary() {
  ...
  lines.push(
    ...
    "UNSUPPORTED reasons: unregistered_bucket | unregistered_field | invalid_value | missing_required_field | uncovered_codepoint | control_character | bidi_override | invisible_format | malformed_encoding | length"
  );
  return lines.join("\n");
}
