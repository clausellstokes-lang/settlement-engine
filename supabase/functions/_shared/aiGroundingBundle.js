...
function deriveFactionArchetype(faction) {
  ...
  const name = typeof faction === "string" ? faction : faction.faction || faction.name || "";
...
function deriveTransport(s, _ctx) {
  ...
  const exports = Array.isArray(s.economicState?.primaryExports) ? s.economicState.primaryExports : Array.isArray(s.economicState?.exports) ? s.economicState.exports : [];
  if (exports.length >= 4) {
    demand += 8;
