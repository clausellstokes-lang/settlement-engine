...
-- Owner RLS from migration 001 covers this column. Migration 020 later
-- removes direct anonymous public settlement row reads; public gallery
-- clients now use sanitized RPCs instead of selecting row JSON directly.
