...
export function defenseThreatProse(settlement, options = {}) {
  ...
  // leaf is offered the readings THIS entry point holds, and is EMPTY until car 9 authors
  // them. An empty list composes to the kernel's own draw, so the manifest cannot move.
