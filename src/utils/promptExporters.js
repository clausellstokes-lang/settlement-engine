...
export const generateNarrativePrompt = (r) => {
  ...
  // ── Header & instructions ─────────────────────────────────────────────────────
  v.push(sec('SettlementForge — AI Synthesis Prompt'));
  v.push(`
This document contains settlement data from SettlementForge. Read it, then follow the instructions below exactly.
...
- Never surface internal validation markers, severity labels, or generator metadata.`);
  ...
  // ── Footer ────────────────────────────────────────────────────────────────────
  v.push(`\n${BAR}`);
  v.push('Generated by SettlementForge');
...
export const generateMapPrompt = (r) => {
  ...
  E.push('');
  E.push(hr('\u2550'));
  E.push('Generated by SettlementForge');
