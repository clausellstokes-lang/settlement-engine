  ...
  return (
    <PageChrome settlement={settlement} narrativeMode={narrativeMode}>
      <Section eyebrow="15" title="AI Appendix" accent={palette.ai}>
        <Text style={{ ...type.italic, color: palette.muted, fontSize: pt['10'], marginBottom: space.md }}>
          ...
          <View style={{ marginBottom: space.lg }}>
            ...
            {(a.dmCompass.hooks || []).length > 0 && (
              <View style={{ marginBottom: space.sm }}>
                <Text style={{ ...type.label, color: palette.ai, fontSize: pt['7.5'], marginBottom: 6 }}>
                  RUN-READY HOOKS
                </Text>
          ...
          <View style={{ marginBottom: space.lg }}>
            ...
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 6 }}>
              {a.identityMarkers.map((m, i) => (
                ...
                >
                  {m.label && (
                    <Text style={{ ...type.label, color: palette.ai, fontSize: pt['7.5'], marginBottom: 2 }}>
                      {upper(m.label)}
                    </Text>
                  )}
