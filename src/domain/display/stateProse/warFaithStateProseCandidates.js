/**
 * domain/display/stateProse/warFaithStateProseCandidates.js — the WarFaith desk's MODIFIER
 ...
 *
 * The desk composes at 1 of the 31 routed call sites (car 3d).
 *
...
/**
 * The WarFaith desk's modifier candidates for one block, in offer order.
 *
 * @param {string} blockId the block being composed, e.g. 'DS-WAR-1'
 ...
 */
export function warFaithStateProseCandidates(blockId, readings) {
  ...
  //   if (blockId === 'DS-WAR-1' && musterIsShort(readings)) fired.push({ key: 'muster: short', change: 0 });
