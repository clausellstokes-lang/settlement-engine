/**
 * domain/display/stateProse/economyStateProseCandidates.js — the Economy desk's MODIFIER
 ...
 *
 * The desk composes at 1 of the 31 routed call sites (car 3c).
 *
...
/**
 * The Economy desk's modifier candidates for one block, in offer order.
 *
 * @param {string} blockId the block being composed, e.g. 'DS-ECO-8'
 ...
 */
export function economyStateProseCandidates(blockId, readings) {
  ...
  //   if (blockId === 'DS-ECO-8' && musterIsShort(readings)) fired.push({ key: 'muster: short', change: 0 });
