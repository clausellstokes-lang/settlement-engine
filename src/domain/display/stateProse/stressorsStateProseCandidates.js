/**
 * domain/display/stateProse/stressorsStateProseCandidates.js — the Stressors desk's MODIFIER
 ...
 *
 * The desk composes at 2 of the 31 routed call sites (car 3b).
 *
...
/**
 * The Stressors desk's modifier candidates for one block, in offer order.
 *
 * @param {string} blockId the block being composed, e.g. 'DS-STR-1'
 ...
 */
export function stressorsStateProseCandidates(blockId, readings) {
  ...
  //   if (blockId === 'DS-STR-1' && musterIsShort(readings)) fired.push({ key: 'muster: short', change: 0 });
