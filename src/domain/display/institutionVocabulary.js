...
export const INSTITUTION_IDENTITY = Object.freeze({
  ...
  Tannery: 'A works that turns raw hides into leather with bark and lime. Foul-smelling, and sited downstream and downwind where the water and the ground allow.',
  ...
  Tanners: 'Leatherworkers who cure hides at scale. Their reek pushes them toward the downstream edge, where the town can spare the ground.',
  ...
  'Message network (high magic)': 'A network of paired speaking stones carrying words across great distance for a fee.',
  ...
  'Scroll scribe': 'A scribe who prepares and sells spell scrolls, from cheap charms to costly greater workings.',
  ...
  'Access to parish church': 'No house of worship of its own; the faithful walk a few miles to the nearest village for the rites.',
  ...
  'Burial ground': 'A plot at the settlement edge where the dead are laid, kept by the households themselves rather than by any clergy.',
  'Parish burial grounds': 'Ground beside each house of worship, with a sexton who keeps the register of who lies where.',
  'Burial grounds and charnel house': 'Grounds outside the gates, and a house where bones are stacked when the old plots are lifted to make room.',
  'Cemetery network': 'Burial grounds beyond every gate, served by their own roads and answering to one central roll of the dead.',
  'Parish churches (2-5)': 'Several houses of worship, each serving its own quarter of a town.',
  ...
  'Parish churches (10-30)': 'A house of worship for every neighbourhood, so no one lives far from a bell.',
  'Parish churches (50-100+)': 'Hundreds of houses of worship across every district, the faith woven into each neighbourhood.',
...
export const INSTITUTION_FLAVOR_AFFINITY = Object.freeze({
  ...
  'Burial ground': ['death', 'rest'],
  'Parish burial grounds': ['death', 'rest', 'record'],
  'Burial grounds and charnel house': ['death', 'rest', 'crowding'],
  'Cemetery network': ['death', 'rest', 'record'],
