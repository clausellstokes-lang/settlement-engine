...
import { RENEGOTIATION_TRIGGER, RENEWAL_TRIGGER } from '../worldPulse/pactRenewal.js';
...
export const REALM_MANIFEST = Object.freeze({
  ...
  // is empty: a renewal re-offers the standing instrument's own clauses (pactRenewal.js). GR-5c's
  // renegotiation word joins it beside renewal, for the same reason: a demand lightens those clauses.
  PROPOSE_PACT: Object.freeze({
    ...
    dials: [
      ...
      enumDial('termType', [...PACT_CLAUSE_TYPES, RENEGOTIATION_TRIGGER, RENEWAL_TRIGGER], PACT_CLAUSE_TYPES[0], 'The clause offered'),
    ],
    targetsFrom: 'campaignSettlements',
