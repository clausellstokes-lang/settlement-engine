...
export const VIRTUAL_SUBSYSTEM_ROWS = Object.freeze([
  ...
  Object.freeze({
    ...
    aliveness: Object.freeze({
      ...
      eventTypes: Object.freeze([]),
      // DELIBERATELY EMPTY, and it is a COMMITMENT rather than an omission: W-COIN-1
      // mints ZERO news kinds. The news bill is priced into W-COIN-2's charter by name
      // (A1.18) — the authoring-census baseline, the herald lane rows, the kind pools and
      // the headline/voice contracts — and declaring a mover family here would grade this
      // row alive off somebody else's beat, which is the recorded moverFamily hazard.
      moverFamilies: Object.freeze([]),
