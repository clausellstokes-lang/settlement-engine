 ...
 *
 * Architectural fit:
 *   - The store's `setAiSettlement` action (src/store/aiSlice.js) is
 *     the natural integration point: pass the original alongside the
 *     refined object and refuse to commit if `ok === false`. This
 *     module ships the verifier; the wiring is a follow-up.
 ...
 *
 * @param {Object|null} original  The settlement BEFORE the AI overlay.
 * @param {Object|null} refined   The settlement AFTER the AI overlay.
 * @returns {{
 *   ok: boolean,
 *   violations: Array<{
 *     kind: string,
