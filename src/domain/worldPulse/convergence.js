...
// ═══════════════════════════════════════════════════════════════════════════════════
// Stage 3 — THE REACTIVE ART OF WAR (design §3) lives in ./convergenceReactive.js and is
// RE-EXPORTED here, so no consumer import site moved. WHY THE SPLIT: this module's own
// header carries the recorded judgment that intervention initiation is WAR-gated and
// deliberately NOT belief-gated ("armies march regardless of the info layer"). Stage 3 is
// the one part of the design that inverts that rule — it is priced on a BELIEVED column
// and is indifferent to whether the column is real. Two opposite laws in one file is how
// a reader learns the wrong one, so the boundary now sits where the header already said
// it was. Nothing moved but the text.
// ═══════════════════════════════════════════════════════════════════════════════════

export { REACTIVE_MOVES, REACTIVE_RELATIONS, reactiveResponse, contestSideLookup } from './convergenceReactive.js';
