...
export const ENGINE_GATED_VIRTUAL_RULE_KEYS = Object.freeze([
  ...
  // ⚠ ONE SIBLING KEY IS STILL CHARTERED AND DELIBERATELY NOT MINTED HERE (A1.2.12's
  // three-key topology, now two-thirds spent): the irregular-force key mints with car
  // SEAT-7, with the car that carries its first gate read, because a flag mint is a train
  // boundary and a key minted ahead of its reader is a manifested key with no measured gate.
  // ⛔ AND ITS NAME IS DELIBERATELY NOT SPELLED IN THIS COMMENT. The mechanism
