...
export const HABIT_FORK_REGISTRY = Object.freeze([
  ...
  fork({
    forkId: 'HBF-01', module: 'src/domain/worldPulse/demographicsMigration.js',
  ...
  fork({
    forkId: 'HBF-02', module: 'src/domain/worldPulse/demographicsPlans.js',
  ...
  fork({
    forkId: 'HBF-03', module: 'src/domain/worldPulse/demographicsResponses.js',
  ...
  fork({
    forkId: 'HBF-04', module: 'src/domain/worldPulse/espionage/espionageDoctrineStage.js',
  ...
  fork({
    forkId: 'HBF-05', module: 'src/domain/worldPulse/espionage/espionageGauntlet.js',
  ...
  fork({
    forkId: 'HBF-06', module: 'src/domain/worldPulse/espionage/espionageRider.js',
  ...
  fork({
    forkId: 'HBF-07', module: 'src/domain/worldPulse/grammarNews.js',
  ...
  fork({
    forkId: 'HBF-08', module: 'src/domain/worldPulse/npcLadderChallenge.js',
  ...
  fork({
    forkId: 'HBF-09', module: 'src/domain/worldPulse/npcLadderContest.js',
  ...
  fork({
    forkId: 'HBF-10', module: 'src/domain/worldPulse/npcLadderContest.js',
  ...
  fork({
    forkId: 'HBF-11', module: 'src/domain/worldPulse/npcLadderContest.js',
  ...
  fork({
    forkId: 'HBF-12', module: 'src/domain/worldPulse/populationDynamics.js',
  ...
  fork({
    forkId: 'HBF-13', module: 'src/domain/worldPulse/pressureModel.js',
  ...
  fork({
    forkId: 'HBF-14', module: 'src/domain/worldPulse/relationshipRulesAdversarial.js',
  ...
  fork({
    forkId: 'HBF-15', module: 'src/domain/worldPulse/sovereigntyMarketStage.js',
  ...
  fork({
    forkId: 'HBF-16', module: 'src/domain/worldPulse/supplyWebWarfare.js',
  ...
  fork({
    forkId: 'HBF-32', module: 'src/domain/region/contestOverThirdParty.js',
  ...
  fork({
    forkId: 'HBF-17', module: 'src/domain/worldPulse/settlementStrategy.js',
  ...
  fork({
    forkId: 'HBF-18', module: 'src/domain/worldPulse/supplyWebWarfare.js',
  ...
  fork({
    forkId: 'HBF-19', module: 'src/domain/worldPulse/tradeWar.js',
  ...
  fork({
    forkId: 'HBF-20', module: 'src/domain/spatial/dispatchEV.js',
  ...
  fork({
    forkId: 'HBF-21', module: 'src/domain/worldPulse/traditionsKernel.js',
  ...
  fork({
    forkId: 'HBF-22', module: 'src/domain/traditions/relations.js',
  ...
  fork({
    forkId: 'HBF-23', module: 'src/domain/worldPulse/piety.js',
  ...
  fork({
    forkId: 'HBF-24', module: 'src/domain/worldPulse/routeNetworkCharter.js',
  ...
  fork({
    forkId: 'HBF-25', module: 'src/domain/worldPulse/routeNetworkGenesis.js',
  ...
  fork({
    forkId: 'HBF-26', module: 'src/domain/spatial/embattlement.js',
  ...
  fork({
    forkId: 'HBF-27', module: 'src/domain/worldPulse/applyWorldPulseRelationshipGraph.js',
  ...
  fork({
    forkId: 'HBF-28', module: 'src/domain/worldPulse/npcLadderGoals.js',
  ...
  fork({
    forkId: 'HBF-29', module: 'src/domain/worldPulse/npcLadderGoals.js',
  ...
  fork({
    forkId: 'HBF-30', module: 'src/domain/worldPulse/npcLadderGoals.js',
    symbol: 'mintGoal', discovery: 'checklist', disposition: 'DEFER',
  ...
  fork({
    forkId: 'HBF-31', module: 'src/domain/worldPulse/espionage/espionageMath.js',
