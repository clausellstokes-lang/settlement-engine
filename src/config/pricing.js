...
// ── W-DOC: pricing-page display derivations (additive; brief §3) ──────────
// The five-band pricing page renders every number from config. These helpers
// derive the display facts the bands need so no surface ever restates a number
// the catalog didn't (the tierFacts.js discipline, extended to the new bands).
