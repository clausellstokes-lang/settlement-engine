/**
 * SupportQueuePanel.jsx — support-agent ticket queue.
 *
 * Built on the least-privilege foundation: every read is REDACTED (masked
 * sender email) and every mutation goes through the audited, role-gated
