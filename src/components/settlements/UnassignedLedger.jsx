...
const ledgerTh = (mobile) => ({ textAlign:'left', fontFamily:sans, fontSize:chromeFontSize(FS.xs, mobile), fontWeight:700, textTransform:'uppercase', letterSpacing:'0.06em', color:SECOND, padding:`0 ${SP.md}px 6px`, borderBottom:`1px solid ${BORDER}`, verticalAlign:'bottom', whiteSpace:'nowrap' });
...
export default function UnassignedLedger({
  ...
  return (
    <section>
      ...
      <h2 style={{ margin:'0 0 6px', paddingLeft:4, fontSize:chromeFontSize(FS.xs, mobile), fontWeight:700, color:SECOND, textTransform:'uppercase', letterSpacing:'0.06em', fontFamily:sans }}>
