...
function KindPill({ kind }) {
  ...
  return (
    <span style={{
      ...
      color: isCampaign ? GOLD_DEEP : SECOND,
      background: CARD_ALT,
          ...
          <div style={{ padding: SP.xl, display: 'grid', gap: SP.md, alignContent: 'center' }}>
            ...
            {detail.realmArcSummary ? (
              <div style={{ borderLeft: `3px solid ${GOLD}`, borderRadius: R.md, background: CARD_ALT, padding: SP.md, maxWidth: PROSE_MAX }}>
                <div style={{ color: GOLD_DEEP, fontFamily: sans, fontSize: FS.xs, fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 4 }}>
                  Realm Chronicle
                </div>
