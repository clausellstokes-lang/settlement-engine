 ...
 * organization corrupts the chosen NPC, and how far the rot reaches (the
 * individual alone, or their home institution in-chain). When the settlement has
 * no criminal organization the picker explains the prerequisite instead of
 * offering an empty select, so the action can never assemble a no-op. Extracted
 * from EventComposer to keep the parent under the line ratchet.
 *
 * Scope 'individual_institution' drives the covert home-institution impairment in
 * mutateEntities.js imposeCorruption (:718-735): a 'corruption'-typed, covert:true
 * setback, exactly what the mode hint describes.
 */
