 ...
 * A real button (OUR Button primitive) with aria-expanded controlling a region,
 * so the groups collapse without trapping focus. The caret + the open/closed word
 * carry the state in two channels (P7), never on a rotation alone. `summary` is
 * quiet scent describing what is inside while closed.
 *
