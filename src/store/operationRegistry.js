...
export const OPERATIONS = Object.freeze({
  ...
  migrateLocalCustomContentToCloud: { opType:'migrateLocalCustomContentToCloud', label:"Migrate local custom content to the cloud", description:"Uploads custom content held only in the local browser to the account's cloud store.", klass:'macro', slice:'customContentSlice', targetScope:'global', receiptRef:null, undoToken:null },
  ...
  addCustomItem: { opType:'addCustomItem', label:"Add a custom item", description:"Adds one custom-content item, such as an institution or a deity. It can be undone with Delete a custom item.", klass:'mechanical', slice:'customContentSlice', targetScope:'global', receiptRef:null, undoToken:'deleteCustomItem' },
  updateCustomItem: { opType:'updateCustomItem', label:"Update a custom item", description:"Writes changed fields onto a custom-content item.", klass:'mechanical', slice:'customContentSlice', targetScope:'global', receiptRef:null, undoToken:null },
  deleteCustomItem: { opType:'deleteCustomItem', label:"Delete a custom item", description:"Removes a custom-content item.", klass:'mechanical', slice:'customContentSlice', targetScope:'global', receiptRef:null, undoToken:null },
