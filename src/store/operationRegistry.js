...
export const OPERATIONS = Object.freeze({
  ...
  // R-0 exposure honesty (atlas store-ops evidence; retire-vs-wire = owner-gated, queue #21):
  // recordSnapshot has NO user-facing caller — its two callers are internal (the
  // commitPendingEdits batch snapshot and revertToSnapshot's auto 'pre-revert'
  // capture). It stays registered because it IS a real mutating verb the walker
  // censuses, but it is an internal seam, not a player-reachable operation.
  ...
  importNeighbour: { opType:'importNeighbour', label:"Import a neighbour", description:"Imports another settlement as a neighbour into the neighbour network.", klass:'macro', slice:'neighbourSlice', targetScope:'global', receiptRef:null, undoToken:null, undoState:'external:clearNeighbour' },
  handleImportDirect: { opType:'handleImportDirect', label:"Import a neighbour directly", description:"Imports a neighbour settlement directly from a supplied payload into the neighbour network.", klass:'macro', slice:'neighbourSlice', targetScope:'global', receiptRef:null, undoToken:null, undoState:'external:clearNeighbour' },
  ...
  setLock: { opType:'setLock', label:"Set a section lock", description:"Locks a section of the settlement so it is preserved when other sections regenerate.", klass:'mechanical', slice:'settlementSlice', targetScope:'save', receiptRef:null, undoToken:null, undoState:'external:inverse-call' },
  clearLocks: { opType:'clearLocks', label:"Clear section locks", description:"Removes all section locks from the settlement.", klass:'mechanical', slice:'settlementSlice', targetScope:'save', receiptRef:null, undoToken:null, undoState:'none' },
  refreshSystemState: { opType:'refreshSystemState', label:"Refresh the system state", description:"Recomputes the settlement's derived system state from its current data.", klass:'mechanical', slice:'settlementSlice', targetScope:'save', receiptRef:null, undoToken:null, undoState:'not-applicable' },
  ...
  syncActiveNeighbourFields: { opType:'syncActiveNeighbourFields', label:"Sync neighbour fields", description:"Updates the active settlement's fields that mirror a linked neighbour.", klass:'mechanical', slice:'settlementSlice', targetScope:'save', receiptRef:null, undoToken:null, undoState:'not-applicable' },
  recordCanonFlavorEntry: { opType:'recordCanonFlavorEntry', label:"Record a flavour entry", description:"Adds a piece of canon flavour text to the settlement's record. It can be undone with Undo last event.", klass:'mechanical', slice:'settlementSlice', targetScope:'save', receiptRef:null, undoToken:'undoLastEvent', undoState:'action' },
  ...
  clearCampaignWizardNews: { opType:'clearCampaignWizardNews', label:"Clear campaign news", description:"Clears the pending news items shown for a campaign.", klass:'mechanical', slice:'campaignSlice', targetScope:'campaign', receiptRef:null, undoToken:null, undoState:'none' },
  ...
  reorderCampaignSettlements: { opType:'reorderCampaignSettlements', label:"Reorder campaign settlements", description:"Changes the display order of settlements within a campaign.", klass:'mechanical', slice:'campaignSlice', targetScope:'campaign', receiptRef:null, undoToken:null, undoState:'external:inverse-call' },
  ensureCampaignRegionalGraph: { opType:'ensureCampaignRegionalGraph', label:"Ensure a regional graph", description:"Creates the campaign's regional graph if it does not exist yet, leaving an existing one unchanged.", klass:'mechanical', slice:'campaignRegionalSlice', targetScope:'campaign', receiptRef:null, undoToken:null, undoState:'not-applicable' },
  ...
  setRegionalChannelVisibility: { opType:'setRegionalChannelVisibility', label:"Set a regional channel's visibility", description:"Sets whether a regional channel is shown.", klass:'mechanical', slice:'campaignRegionalSlice', targetScope:'campaign', receiptRef:null, undoToken:null, undoState:'external:inverse-call' },
  ...
  queueCampaignRegionalImpacts: { opType:'queueCampaignRegionalImpacts', label:"Queue regional impacts", description:"Adds regional impacts to the campaign's queue to be applied over time.", klass:'mechanical', slice:'campaignRegionalSlice', targetScope:'campaign', receiptRef:null, undoToken:null, undoState:'undetermined' },
  ...
  setAiDailyLife: { opType:'setAiDailyLife', label:"Set the AI daily-life account", description:"Stores an AI daily-life account for the settlement. It can be reverted to the raw text.", klass:'mechanical', slice:'aiSlice', targetScope:'save', receiptRef:null, undoToken:'revertCurrentToRaw', undoState:'action' },
  ...
  setDossierEntitlement: { opType:'setDossierEntitlement', label:"Set a dossier entitlement", description:"Grants a dossier entitlement in the store. It can be cleared.", klass:'mechanical', slice:'authSlice', targetScope:'global', receiptRef:null, undoToken:'clearDossierEntitlements', undoState:'action' },
  ...
  replaceAllPlacements: { opType:'replaceAllPlacements', label:"Replace all map placements", description:"Replaces every placement on the campaign map at once.", klass:'mechanical', slice:'mapSlice', targetScope:'campaign', receiptRef:null, undoToken:null, undoState:'irreversible' },
  ...
  setNeighbourRelType: { opType:'setNeighbourRelType', label:"Set a neighbour relationship type", description:"Sets the relationship type, such as ally or rival, for a neighbour link.", klass:'mechanical', slice:'neighbourSlice', targetScope:'global', receiptRef:null, undoToken:null, undoState:'external:inverse-call' },
  addNeighbourLink: { opType:'addNeighbourLink', label:"Add a neighbour link", description:"Creates a link between two settlements in the neighbour network.", klass:'mechanical', slice:'neighbourSlice', targetScope:'global', receiptRef:null, undoToken:null, undoState:'external:removeNeighbourLink' },
  removeNeighbourLink: { opType:'removeNeighbourLink', label:"Remove a neighbour link", description:"Removes a link between two settlements from the neighbour network.", klass:'mechanical', slice:'neighbourSlice', targetScope:'global', receiptRef:null, undoToken:null, undoState:'external:addNeighbourLink' },
  setNeighbourNetwork: { opType:'setNeighbourNetwork', label:"Set the neighbour network", description:"Replaces the entire neighbour network with a given network.", klass:'mechanical', slice:'neighbourSlice', targetScope:'global', receiptRef:null, undoToken:null, undoState:'irreversible' },
  ...
  addCredits: { opType:'addCredits', label:"Add credits", description:"Increases the account's narrative-credit balance.", klass:'mechanical', slice:'creditsSlice', targetScope:'global', receiptRef:null, undoToken:null, undoState:'external:server-rebalance' },
  spendCredits: { opType:'spendCredits', label:"Spend credits", description:"Decreases the account's narrative-credit balance when a paid action is taken.", klass:'mechanical', slice:'creditsSlice', targetScope:'global', receiptRef:null, undoToken:null, undoState:'external:server-rebalance' },
  ...
  resetConfig: { opType:'resetConfig', label:"Reset the generation settings", description:"Restores the generation settings to their defaults.", klass:'mechanical', slice:'configSlice', targetScope:'global', receiptRef:null, undoToken:null, undoState:'not-applicable' },
  setSettlementType: { opType:'setSettlementType', label:"Set the settlement type", description:"Sets the settlement type, such as village or city, in the generation settings.", klass:'mechanical', slice:'configSlice', targetScope:'global', receiptRef:null, undoToken:null, undoState:'external:inverse-call' },
  ...
  mergeInstitutionToggles: { opType:'mergeInstitutionToggles', label:"Merge institution choices", description:"Merges a set of institution on-or-off choices into the current ones.", klass:'mechanical', slice:'toggleSlice', targetScope:'global', receiptRef:null, undoToken:null, undoState:'external:inverse-call' },
  ...
  resetToggles: { opType:'resetToggles', label:"Reset all toggles", description:"Restores every institution, category, goods, and service choice to its default.", klass:'mechanical', slice:'toggleSlice', targetScope:'global', receiptRef:null, undoToken:null, undoState:'not-applicable' },
  resetGoodsServices: { opType:'resetGoodsServices', label:"Reset goods and services", description:"Restores the trade-good and service choices to their defaults.", klass:'mechanical', slice:'toggleSlice', targetScope:'global', receiptRef:null, undoToken:null, undoState:'not-applicable' },
