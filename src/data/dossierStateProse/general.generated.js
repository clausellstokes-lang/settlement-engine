...
// THE OVERVIEW / RELATIONS / POPULATION / HOOKS DESK — projected from docs/content/RECEIPT_POOLS_DOSSIER_STATE.md (DS-GEN- + DS-REL- + DS-POP- + DS-HK-): 23 blocks, 637 variants.
...
export const DOSSIER_STATE_PROSE_GENERAL = /* #__PURE__ */ Object.freeze({
  ...
  "DS-GEN-3": {
    ...
    "pools": {
      ...
      "purse: short": [
        {
          "angle": "plain",
          "text": "The purse at {settlement} falls short of what its defences cost to keep.",
          "slots": [
            "settlement"
          ],
          "vid": 1,
          "wordings": [
            "What {settlement} lays out does not answer the upkeep of its defences.",
            "Less coin goes to the defences at {settlement} than their keeping.",
            "Set against the charge of holding its defences, what {settlement} pays is the smaller sum."
          ]
        },
        {
          "angle": "plain",
          "text": "The upkeep of the defences {settlement} pays for is not met in full.",
          "slots": [
            "settlement"
          ],
          "vid": 2,
          "wordings": [
            "Where {settlement} pays for its defence, it pays under the keep.",
            "Whatever {settlement} keeps by paying for, it keeps on short means.",
            "Short of what it costs is how the paid defence at {settlement} stands."
          ]
        },
        {
          "angle": "plain",
          "text": "So far as paying goes, the defences at {settlement} are kept short of their upkeep.",
          "slots": [
            "settlement"
          ],
          "vid": 3,
          "wordings": [
            "For the keeping of its defences, {settlement} does not find the whole charge.",
            "The defence {settlement} pays for is paid for in part.",
            "By the muster roll's own account, {settlement} keeps its defences under their charge."
          ]
        }
      ]
    },
  ...
  "DS-GEN-12": {
    "title": "DS-GEN-12 · Overview › The ground and the approaches (how the site disposes the town) · `config.terrainType` read as terrain families",
    "sectionTarget": [
      "overview",
      "history"
    ],
    ...
    "pools": {
      "WATER-EDGE": [
        ...
        {
          "angle": "street",
          "text": "In {settlement} the way to anywhere important runs along the water or down to it.",
          "slots": [
            "settlement"
          ],
          "vid": 3
      ...
      "HIGH-GROUND": [
        {
          "angle": "visitor",
          "text": "{settlement} sits where the ground made standing possible rather than easy, and the town's shape is the ground's ruling on the matter.",
          "slots": [
            "settlement"
          ],
          "vid": 1
        ...
        {
          "angle": "ledger",
          "text": "What {settlement} spends on carrying things up, it recovers in what the high ground spares it.",
          "slots": [
            "settlement"
          ],
          "vid": 3
      ...
      "WOODLAND": [
        ...
        {
          "angle": "elder",
          "text": "The town's edge against the trees has been argued over for as long as anyone has kept the argument.",
          "slots": [],
          "vid": 2
        },
        {
      ...
      "OPEN-GROUND": [
        ...
        {
          "angle": "street",
          "text": "The fields begin where {settlement} loses interest, and not before.",
          "slots": [
            "settlement"
          ],
          "vid": 3
  ...
  "DS-GEN-13": {
    "title": "DS-GEN-13 · Overview/Economics › The market and the roads (where the town trades, and why there) · market-class institution presence × `config.tradeRouteAccess` × `economicState.isEntrepot`",
    "sectionTarget": [
      "overview",
      "economy"
    ],
    ...
    "pools": {
      "MARKET-OPEN": [
        {
          "angle": "street",
          "text": "Market day is {settlement} at its truest: the roads bring the custom, and the custom is the argument for the stalls.",
          "slots": [
            "settlement"
          ],
          "vid": 1
        ...
        {
          "angle": "visitor",
          "text": "A stranger finds {settlement}'s market without directions, because the busiest way through town leads there on its own.",
          "slots": [
            "settlement"
          ],
          "vid": 3
      ...
      "ENTREPOT": [
        ...
        {
          "angle": "street",
          "text": "In {settlement} the {good} on the stalls has usually seen more of the world than the people selling it.",
          "slots": [
            "settlement",
            "good"
          ],
  ...
  "DS-GEN-14": {
    "title": "DS-GEN-14 · History › Founded once, grown since (the first cause, and the accretion over it) · `history.founding` presence × `history.age` banded",
    "sectionTarget": [
      "history",
      "overview"
    ],
    ...
    "pools": {
      ...
      "GROWN-UNRECORDED": [
        ...
        {
          "angle": "street",
          "text": "{settlement} was never founded so much as agreed to, one household at a time.",
          "slots": [
            "settlement"
          ],
          "vid": 2
  ...
  "DS-POP-3": {
    "title": "DS-POP-3 · Population/History › The direction of the roll, read against the approach · the trend band over `settlement.populationHistory` × `config.tradeRouteAccess`",
    "sectionTarget": [
      "population",
      "overview"
    ],
  ...
  "DS-GEN-15": {
    "title": "DS-GEN-15 · History › The fabric wears it (what the town's stones still carry) · `settlement.urbanFabric` through `fabricRead`",
    "sectionTarget": [
      "history",
      "overview"
    ],
  ...
  "DS-GEN-16": {
    "title": "DS-GEN-16 · History › What the years left standing (the recorded blow, and whether the record carries it forward) · `history.historicalEvents[]{type, yearsAgo, severity, anchored, lastingEffects[]}`",
    "sectionTarget": [
      "history",
      "tensions"
    ],
    ...
    "pools": {
      "ANCHORED-RECENT": [
        ...
        {
          "angle": "visitor",
          "text": "{settlement} has the particular carefulness of a town that was lately reminded what can happen to towns.",
          "slots": [
            "settlement"
          ],
          "vid": 3
  ...
  "DS-GEN-17": {
    "title": "DS-GEN-17 · Overview/Power › The company the town keeps (what the roster says about the place) · `compound.inst{hasCourtSystem, hasPrison, hasHospital, hasChurch, hasGranary, hasPort, hasNavy, hasMagicInst}` × tier",
    "sectionTarget": [
      "overview",
      "power"
    ],
    ...
    "pools": {
      "ADMINISTERED": [
        ...
        {
          "angle": "visitor",
          "text": "{settlement} is administered, visibly: rules here have rooms, and the rooms have officers.",
          "slots": [
            "settlement"
          ],
          "vid": 2
      ...
      "GARRISONED": [
        ...
        {
          "angle": "ledger",
          "text": "{settlement} pays for its own defense in wages, not only in stone, and the paying is a standing decision renewed every season.",
          "slots": [
            "settlement"
          ],
          "vid": 2
      ...
      "BARE": [
        ...
        {
          "angle": "street",
          "text": "Nothing in {settlement} is official that could instead be somebody's job on the side.",
          "slots": [
            "settlement"
          ],
          "vid": 2
  ...
  "DS-GEN-18": {
    "title": "DS-GEN-18 · Economics/Services › Why these workshops (the crafts explained by their feed) · `economicState.activeChains[]` × `resourceAnalysis.exploitation` × `economicState.{isEntrepot, primaryImports}`",
    "sectionTarget": [
      "economy",
      "overview"
    ],
