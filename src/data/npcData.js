 ...
 * descriptor strings; lookups normalize case + trim. Pure data — frozen so a
 * typo'd key reads as `undefined` (→ 0), not a silent miss.
 *
 * Consumed by worldPulse/disposition.js (the war-layer aggression baseline);
 * dormant for a legacy campaign (that consumer is gated behind warLayerEnabled).
 */
