...
export const RESOURCE_DATA = {
  ...
  managed_forest: {
    ...
    tradeGoods: ["Milled timber", "Charcoal", "Hardwood beams"],
    forbidden: ["port", "crossroads"],
    warning: null,
    category: "land",
  },
  foraging_areas: {
    ...
    icon: "",
    desc: "Mushrooms, berries, medicinal herbs, and wild plants for herbalists and alchemists",
    commodities: ["honey", "medicinal_herbs"],
    instBoosts: { apoth: 2.2, alchemist: 1.5, healer: 1.3 },
    tradeGoods: ["Medicinal herbs", "Alchemical reagents", "Wild honey"],
    forbidden: ["port"],
    warning: null,
    category: "land",
  },
  ancient_grove: {
    label: "Ancient Grove",
    icon: "",
    desc: "Old-growth forest with religious or mystical weight; draws druids and pilgrims",
    commodities: ["medicinal_herbs", "honey"],
    instBoosts: { druid: 2, church: 1.3, shrine: 1.6, magic: 1.2 },
    tradeGoods: ["Sacred wood", "Ritual components"],
    forbidden: ["port", "crossroads"],
    warning: null,
    category: "special",
  },
  grain_fields: {
    ...
    tradeGoods: ["Grain surplus", "Milled flour", "Bulk food exports"],
  ...
  crossroads_position: {
    ...
    tradeGoods: ["Transit trade", "Toll revenue"],
    forbidden: ["isolated", "port", "river"],
    warning: "A crossroads position requires crossroads trade access.",
    category: "special",
  },
  iron_deposits: {
    label: "Iron Ore Deposits",
    icon: "️",
    desc: "Accessible iron ore veins feed local metalworking and weapon production.",
    commodities: ["iron", "metalwork"],
    instBoosts: { smith: 1.8, smelter: 2.2, mine: 2.5, specialized: 1.8 },
    tradeGoods: ["Iron ore", "Basic metalwork", "Weapons and armour"],
    forbidden: ["port"],
    warning: null,
  ...
  stone_quarry: {
    label: "Stone quarry",
    icon: "",
    desc: "Accessible limestone, granite, or sandstone; cuts the cost of building in stone",
    commodities: ["stone"],
    instBoosts: { mason: 1.8, quarry: 2.5, stonemason: 1.6 },
    tradeGoods: ["Quarried stone", "Building materials"],
    forbidden: ["port"],
    warning: null,
    category: "subterranean",
  },
  precious_metals: {
    ...
    icon: "",
    desc: "Silver, gold, or copper deposits; draws merchants and the first banks",
    commodities: ["luxury", "gems"],
    instBoosts: { jewel: 2, mint: 2.5, bank: 1.5, guild: 1.3, merchant: 1.4 },
    tradeGoods: ["Precious metals", "Coin minting", "Jewellery"],
    forbidden: ["port", "river", "crossroads"],
    warning: null,
    category: "subterranean",
  },
  gemstone_deposits: {
    ...
    tradeGoods: ["Raw gemstones", "Cut gemstones", "Luxury goods"],
  ...
  ancient_ruins: {
    ...
    tradeGoods: ["Recovered artefacts", "Rare texts"],
    forbidden: [],
    warning: null,
    category: "special",
  },
  hot_springs: {
    ...
    icon: "️",
    desc: "Natural thermal springs with a name for healing; draws pilgrims and the infirm",
    commodities: ["medicinal_herbs"],
    instBoosts: { healer: 2.0, church: 1.4, inn: 1.8 },
    tradeGoods: ["Healing waters (bottled)", "Pilgrim hospitality"],
    forbidden: ["port", "crossroads", "road"],
    warning: null,
    category: "special",
  },
  magical_node: {
    ...
    tradeGoods: ["Arcane reagents", "Magical services"],
    forbidden: [],
    warning: null,
    category: "special",
  },
  defended_pass: {
    ...
    tradeGoods: ["Toll revenue", "Pass transit trade"],
    forbidden: ["port", "river", "crossroads"],
    warning: null,
    category: "special",
  },
  marshlands: {
    ...
    tradeGoods: ["Reeds and thatch", "Peat fuel", "Waterfowl"],
    forbidden: ["port", "crossroads", "mountain_pass"],
    warning: null,
    category: "land",
  },
  oasis_water: {
  ...
  glass_sand: {
    ...
    tradeGoods: ["Raw sand", "Glass blanks"],
    forbidden: ["port", "river"],
    warning: null,
    category: "subterranean",
  },
  ...
  hot_springs_mineral: {
    ...
    tradeGoods: ["Mineral salts", "Alum", "Sulfur"],
    forbidden: ["port"],
    warning: null,
    category: "special",
  },
...
export const SPECIAL_RESOURCES = {
  ancientRuins: {
    ...
    effects: {
      institutionModifiers: [
        { name: "Sage/library", modifier: 1.5 },
        { name: "Antiquarian", modifier: 2 },
        { name: "Adventurers' guild hall", modifier: 1.5 },
      ],
      resources: ["ancient stone", "relics", "knowledge"],
      tourism: !0,
    },
  },
  magicalNode: {
    name: "Magical Ley Line Node",
    ...
    effects: {
      ...
      resources: ["magical crystals", "ley energy"],
      strategicImportance: "High magical value",
    },
  },
  holySite: {
    name: "Holy Site",
    ...
    effects: {
      ...
      resources: ["religious relics", "pilgrim donations"],
      pilgrimage: !0,
    },
  },
  hotSprings: {
  ...
  richVein: {
    name: "Rich Ore Vein",
    description: "Exceptionally productive mine",
    effects: {
      institutionModifiers: [
  ...
  strategicPass: {
    ...
    effects: {
      ...
      strategicImportance: "Controls passage",
      economicBoost: "Toll and customs revenue",
    },
  },
};
