  ...
  food_security: {
    ...
    chains: [
      ...
      },
      {
        ...
        processingInstitutions: ["Cooper", "Stable master", "Common grazing land", "Dairy farmer", "Shepherd", "Stable yard", "Pack animal trader", "Horse market"],
      ...
      },
      {
        ...
        minTier: 'hamlet',
        entrepotNote: 'Salt is among the most-traded commodities. Port and crossroads settlements profit from redistribution.',
      },
      {
        id: 'forage',
      ...
      },
      {
        ...
        processingInstitutions: ["Fisher's landing", "Fishmonger", "Cooper", "Salt works", "Merchant guilds (3-8)", "Weekly market", "Fish market", "Fishmonger"],
    ...
    chains: [
      {
        ...
        processingInstitutions: ["Sawmill", "Carpenter (part-time)", "Carpenters (5-15)", "Thatcher", "Carpenter (part-time)", "Carpenter"],
    ...
    chains: [
      {
        ...
        processingInstitutions: ["Tailor's guild", "Weavers/Textile workers", "Shepherd", "Fuller", "Dyer", "Dyers' workshop"],
      ...
      },
      {
        ...
        outputs: ['Luxury manufactured goods', 'Fine metalwork and jewelry', 'Extreme luxury goods', 'Master-crafted weapons'],
        services: [],
        exportable: true,
        entrepot: true,
        entrepotNote: 'Luxury goods are the primary cargo of long-distance trade. Entrepôt cities profit enormously from the markup.',
        minTier: 'city',
      },
      {
        id: 'glass_print',
    ...
    chains: [
      {
        ...
        exportable: true,
        entrepot: true,
        entrepotNote: 'Produced in distant lands. Crossroads and port settlements control distribution and take the markup.',
        minTier: 'town',
      },
      {
        ...
        exportable: true,
        entrepot: true,
        entrepotNote: 'Silk is not produced locally at any tier. Port cities control import; crossroads cities control inland distribution.',
        minTier: 'city',
      },
      {
        id: 'transit_finance',
        ...
        exportable: false,
        entrepot: true,
        entrepotNote: 'Entrepôt cities develop banking infrastructure to facilitate large-volume trade. The bank profits from the flow of others.',
        minTier: 'town',
      },
      {
        ...
        exportable: false,
        entrepot: true,
        entrepotNote: 'Ports and crossroads profit by charging for storage, loading, and onward transport — not by producing anything themselves.',
        minTier: 'town',
      },
      {
        id: 'furs_north',
        ...
        exportable: true,
        entrepot: true,
        entrepotNote: 'Furs originate in frontier/northern settlements and travel south through trading posts. Mid-route settlements profit from the trade.',
        minTier: 'hamlet',
      },
      {
        id: 'wine_spirits',
        ...
        exportable: true,
        entrepot: true,
        entrepotNote: 'Wine is produced in specific vineyard regions and consumed everywhere. Port and river settlements profit from redistribution.',
        minTier: 'village',
      },
      {
        id: 'caravan_trade',
        ...
        processingInstitutions: ["Caravaneer's post", "Caravan masters' exchange", "Carriers' guild", "Carriers' hiring hall"],
  ...
  defense_security: {
    ...
    chains: [
      ...
      },,
      {
        ...
        resourceIcon: '️',
        rawInputs: [],
        processingInstitutions: ["Adventurers' charter hall", "Adventurers' guild", "Multiple adventurers' guilds", "Veteran's lodge"],
        intermediateGoods: [],
    ...
    chains: [
      {
        ...
        processingInstitutions: ["Apothecary (established)", "Apothecary district", "Warden's Lodge", "Elder Grove Council"],
  ...
  arcane_magical: {
    ...
    chains: [
      ...
      },
      {
        ...
        intermediateGoods: [],
        outputs: ['Spellcasting (1st-3rd level)', 'Magical identification', 'Enchanting services', 'Wizard\'s tower', 'Spellcasting (1st-8th level)', 'Teleportation', 'Mages\' guild'],
        services: ['magic'],
        exportable: true,
        entrepot: false,
        minTier: 'town',
      },
      {
        ...
        outputs: ['Magical item market', 'Weapon enchantment', 'Armour warding', 'Utility enchantments', 'Extraplanar goods'],
        services: ['magic'],
        exportable: true,
        entrepot: true,
        entrepotNote: 'Magical items are among the highest-value trade goods. Cities near magical nodes become distribution hubs.',
        minTier: 'town',
      },
      {
        id: 'planar',
        ...
        exportable: true,
        entrepot: true,
        entrepotNote: 'Planar goods are extreme-value entrepôt items. Only metropolis-level settlements can support the infrastructure.',
        minTier: 'city',
      },
    ],
  },
    ...
    chains: [
      {
        ...
        processingInstitutions: ["Almshouse", "Foundling home"],
        intermediateGoods: [],
        outputs: ['Religious services', 'Education (basic)', 'Poor relief', 'Record keeping', 'Sanctuary', 'Medical care (basic)', 'Illuminated manuscripts'],
        services: ['healing'],
        exportable: false,
        entrepot: false,
        minTier: 'thorp',
    ...
    chains: [
      {
        ...
        exportable: false,
        entrepot: true,
        entrepotNote: 'Smuggling is the dark entrepôt model. Goods that cannot be taxed or declared flow through criminal infrastructure.',
        minTier: 'thorp',
      },
      {
        id: 'black_market',
      ...
      },
      {
        ...
        processingInstitutions: ["Thieves' guild (powerful)"],
        intermediateGoods: [],
        outputs: ['Information brokerage', 'Guild protection', 'Contract killing', 'Intimidation services', 'Comprehensive black market'],
        services: ['criminal'],
        exportable: false,
        entrepot: false,
        minTier: 'town',
...
const ITEM_CATEGORIES = {
  ...
  raw: {
    ...
    items: [
      'Grain surplus', 'Agricultural surplus', 'Raw wool', 'Raw wool and hides',
      'Livestock', 'Eggs', 'Eggs and dairy', 'Dairy products', 'Honey and beeswax',
      'Foraged goods', 'Small game', 'Furs and pelts', 'Game meat', 'Hunting trophies',
      'Iron ore', 'Basic metalwork', 'Quarried stone', 'Building materials',
      'Milled timber', 'Hardwood beams', 'Charcoal', 'Shipbuilding timber',
      'Coal', 'Peat fuel', 'Sea salt', 'Salt for preservation',
      'Precious metals', 'Coin minting', 'Raw gemstones', 'Cut gemstones',
      'River fish', 'Freshwater catch', 'Medicinal herbs', 'Wild honey',
      'Alchemical reagents', 'Sacred wood', 'Ritual components',
      'Fired brick', 'Pottery and ceramics', 'Reeds and thatch', 'Waterfowl',
      'Recovered artefacts', 'Rare texts', 'Monster components',
    ],
  },
  // CONSUMABLES
  consumable: {
    ...
    items: [
      'Milled flour', 'Baked goods', 'Preserved foods', 'Meals and drink',
      'Food and drink (all grades)', 'Bulk food exports', 'Food surplus',
      'Bulk food', 'Massive food requirements', 'Salt', 'Salt for preservation',
      'Potions and elixirs', 'Herbal remedies', 'Medical care (basic)',
      'Healing waters (bottled)', 'Alchemical products', 'Smoke and flash powder',
      'Beer', 'Wine', 'Spices and exotic dyes', 'Rare spices and dyes',
    ],
  },
  // MANUFACTURED GOODS
  manufactured: {
    ...
    items: [
      'Guild-manufactured goods', 'Processed textiles', 'Quality tools and weapons',
      'Barrels and containers', 'Leather goods', 'Rope and cordage',
      'Basic metalwork', 'Advanced weapons and armor', 'Master-crafted weapons',
      'Fine metalwork and jewelry', 'Luxury manufactured goods', 'Extreme luxury goods',
      'Fine textiles', 'Dyed cloth', 'Luxury textiles', 'Glassware',
      'Books and manuscripts', 'Illuminated manuscripts', 'Printed texts',
      'Ship chandlery', 'Weaponry', 'Armour', 'Tools',
      'Manufactured goods', 'Specialized guild crafts',
      'Extraplanar goods', 'Magical items',
    ],
  },
  // SERVICES
  service: {
    ...
    items: [
      'Legal services', 'Financial services', 'International banking services',
      'Educational services', 'Political influence', 'Printing services',
      'Architectural services', 'High art and culture',
      'Cargo handling', 'Vessel hire', 'Maritime insurance', 'Ship repair',
      'Armed escort', 'Mercenary hire', 'Training services',
      'Medical treatment', 'Surgery', 'Quarantine', 'Medical training',
      'Religious services', 'Poor relief', 'Sanctuary', 'Record keeping',
      'Civil disputes', 'Criminal trials', 'Notary services',
      'Spellcasting (1st-3rd level)', 'Wizard\'s tower',
      'Spellcasting (1st-8th level)', 'Teleportation', 'Mages\' guild',
      'Magical identification', 'Enchanting services', 'Arcane research',
      'Divination and scrying', 'Information brokerage', 'Intelligence services',
      'Long-distance messages', 'Diplomatic access', 'Planar travel information',
      'Contract board', 'Equipment hire', 'Hiring hall', 'Monster bounties',
      'Performances', 'Music and song', 'Gambling', 'Public games',
      'Lodging', 'Lodging (all grades)', 'Stabling', 'Message relay',
      'Transit trade', 'Toll revenue', 'Pass transit trade', 'Pilgrim hospitality',
    ],
  },
};
...
export const RESOURCE_TO_CHAINS = {
  ...
  fertile_floodplain:  ['food_security.grain', 'food_security.livestock', 'food_security.brewing', 'food_security.animal_husbandry'],
  grazing_land:        ['food_security.livestock', 'food_security.brewing', 'food_security.animal_husbandry', 'manufacturing.textiles', 'manufacturing.leather', 'manufacturing.textile_finishing', 'manufacturing.leather_goods'],
  hunting_grounds:     ['food_security.forage', 'food_security.hunting', 'trade_entrepot.furs_north', 'manufacturing.leather', 'manufacturing.leather_goods'],
  managed_forest:      ['raw_extraction.timber', 'raw_extraction.fuel', 'raw_extraction.shipbuilding', 'manufacturing.bowyer_fletcher', 'raw_extraction.petty_mining'],
  ...
  river_mills:         ['manufacturing.food_processing', 'manufacturing.textiles', 'manufacturing.textile_finishing', 'manufacturing.ceramics_brick'],
  ...
  iron_deposits:       ['raw_extraction.iron', 'raw_extraction.smelting', 'raw_extraction.petty_mining', 'manufacturing.weapons_armor'],
  ...
  precious_metals:     ['manufacturing.luxury_goods', 'raw_extraction.precious_metals_mining', 'trade_entrepot.transit_finance'],
  ...
  foraging_areas:      ['food_security.forage', 'food_security.beekeeping_wax', 'healing_medicine.herbalism', 'arcane_magical.alchemy'],
  ancient_grove:       ['religion_civic.parish', 'healing_medicine.herbalism', 'food_security.forage', 'food_security.beekeeping_wax'],
  marshlands:          ['food_security.forage', 'raw_extraction.reed_marsh', 'raw_extraction.fuel'],
  crossroads_position: ['trade_entrepot.warehouse_logistics', 'trade_entrepot.transit_finance', 'trade_entrepot.spices_dyes', 'trade_entrepot.caravan_trade'],
  defended_pass:       ['trade_entrepot.warehouse_logistics', 'trade_entrepot.caravan_trade', 'defense_security.garrison'],
  ancient_ruins:       ['knowledge_information.scholarship', 'knowledge_information.intelligence', 'arcane_magical.spellcasting'],
