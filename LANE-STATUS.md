# LANE-STATUS — written 2026-09-13 06:41:55 by snapshot-lanes.sh (auto every 5 min; a successor reads THIS first, then RESUME-NOTE.md)
...
- **wf_c31490ff-2d1** (mtime 09-13 06:27): agent calls 12 (12 distinct) · DONE 11 · FAILED (not retried) 0 · RETRIED (superseded attempts) 0 · IN FLIGHT 1 — mirror `_progress/wf_c31490ff-2d1/`
    ...
    - `a2c6fee01` SELECTOR Invasion & War: force with NO walls · IN FLIGHT · transcript 09-13 06:41 1004 KB · 20 tool calls · files: draft.md · last: Bash cd /private/tmp/claude-502/-Users-cstokes-Desktop-settlement-engine/4e3d2f70-f45f-4e14-b571-514c339cfa17/scrat
