# LANE-STATUS — written 2026-09-15 21:55:50 by snapshot-lanes.sh (auto every 5 min; a successor reads THIS first, then RESUME-NOTE.md)
...
- **wf_5cfb61a3-06d** (mtime 09-15 21:44): agent calls 3 (3 distinct) · DONE 2 · FAILED (not retried) 0 · RETRIED (superseded attempts) 0 · IN FLIGHT 1 — mirror `_progress/wf_5cfb61a3-06d/`
    ...
    - `a74c64cde` ? · IN FLIGHT · transcript 09-15 21:53 982 KB · 49 tool calls · last: Bash C=/private/tmp/claude-502/-Users-cstokes-Desktop-settlement-engine/4e3d2f70-f45f-4e14-b571-514c339cfa17/scratc
