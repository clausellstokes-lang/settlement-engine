# LANE-STATUS — written 2026-09-13 10:53:49 by snapshot-lanes.sh (auto every 5 min; a successor reads THIS first, then RESUME-NOTE.md)
...
- **DS-DEF-2 (waits for the tables)** dock `laneRW-DEF2` HEAD fb81210b2 · 30 cars over f2da5a3ee · porcelain 2 · last commits:
...
- **wf_74510771-4fe** (mtime 09-13 08:53): agent calls 21 (21 distinct) · DONE 20 · FAILED (not retried) 1 · RETRIED (superseded attempts) 0 · IN FLIGHT 0 — mirror `_progress/wf_74510771-4fe/`
    ...
    - `a57e7fc30` GATE r1 · FAILED · transcript 09-13 08:57 616 KB · 28 tool calls
