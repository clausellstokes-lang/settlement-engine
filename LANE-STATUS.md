# LANE-STATUS — written 2026-09-13 12:06:35 by snapshot-lanes.sh (auto every 5 min; a successor reads THIS first, then RESUME-NOTE.md)
...
- **DS-DEF-2 (waits for the tables)** dock `laneRW-DEF2` HEAD d57c601cf · 31 cars over f2da5a3ee · porcelain 1 · last commits:
...
- **wf_74510771-4fe** (mtime 09-13 11:58): agent calls 33 (32 distinct) · DONE 31 · FAILED (not retried) 0 · RETRIED (superseded attempts) 1 · IN FLIGHT 1 — mirror `_progress/wf_74510771-4fe/`
    ...
    - `a989454e9` GATE r1 · IN FLIGHT · transcript 09-13 12:06 760 KB · 57 tool calls · last: Bash cd /private/tmp/claude-502/-Users-cstokes-Desktop-settlement-engine/4e3d2f70-f45f-4e14-b571-514c339cfa17/scrat
