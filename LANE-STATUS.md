# LANE-STATUS — written 2026-09-15 13:05:55 by snapshot-lanes.sh (auto every 5 min; a successor reads THIS first, then RESUME-NOTE.md)
...
- HOLD-VITEST absent · runner count 14
...
- **wf_406e67e7-fa9** (mtime 09-15 12:49): agent calls 10 (10 distinct) · DONE 9 · FAILED (not retried) 0 · RETRIED (superseded attempts) 0 · IN FLIGHT 1 — mirror `_progress/wf_406e67e7-fa9/`
    ...
    - `ac2ac2537` r3 · IN FLIGHT · transcript 09-15 13:05 688 KB · 27 tool calls · files: $SC/src-files.txt, $SC/test-files.txt, $SC/src-imports.txt · last: Bash SC=/private/tmp/claude-502/-Users-cstokes-Desktop-settlement-engine/f6ac0d98-bb14-48ae-88d1-c6887f1e2704/scrat
