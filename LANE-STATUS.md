# LANE-STATUS — written 2026-09-13 06:26:08 by snapshot-lanes.sh (auto every 5 min; a successor reads THIS first, then RESUME-NOTE.md)
...
- **wf_c31490ff-2d1** (mtime 09-13 06:15): agent calls 9 (9 distinct) · DONE 7 · FAILED (not retried) 0 · RETRIED (superseded attempts) 0 · IN FLIGHT 2 — mirror `_progress/wf_c31490ff-2d1/`
