# LANE-STATUS — written 2026-09-13 04:25:31 by snapshot-lanes.sh (auto every 5 min; a successor reads THIS first, then RESUME-NOTE.md)
...
- **DS-DEF-2 (waits for the tables)** dock `laneRW-DEF2` HEAD 95760e212 · 21 cars over f2da5a3ee · porcelain 8 · last commits:
    ...
    porcelain (uncommitted work in the dock — commit it FIRST after re-proving):
       ...
       M tests/lint/composeStateProseFence.test.js
      ?? src/data/institutionRoles.js
      ?? tests/domain/institutionRoles.test.js
