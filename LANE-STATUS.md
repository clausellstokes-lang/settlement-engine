# LANE-STATUS — written 2026-09-13 06:47:11 by snapshot-lanes.sh (auto every 5 min; a successor reads THIS first, then RESUME-NOTE.md)
...
- **wf_c31490ff-2d1** (mtime 09-13 06:43): agent calls 13 (13 distinct) · DONE 12 · FAILED (not retried) 0 · RETRIED (superseded attempts) 0 · IN FLIGHT 1 — mirror `_progress/wf_c31490ff-2d1/`
    ...
    - `afc0f79bf` GATE r1 · IN FLIGHT · transcript 09-13 06:47 558 KB · 25 tool calls · last: Bash cat > /private/tmp/claude-502/-Users-cstokes-Desktop-settlement-engine/4e3d2f70-f45f-4e14-b571-514c339cfa17/sc
