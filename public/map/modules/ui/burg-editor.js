...
function editBurg(id) {
  ...
  function changeGroup() {
    ...
    Settlements.changeGroup(burg, this.value);
  }
  ...
  function toggleCapital(burgId) {
    ...
    Settlements.changeGroup(oldCapital);
  }
  ...
  function updateBurgPreview(burg) {
    const preview = Settlements.getPreview(burg).preview;
    if (!preview) {
  ...
  function openBurgLink() {
    const id = +elSelected.attr("data-id");
    const burg = pack.burgs[id];
    const link = Settlements.getPreview(burg).link;
  ...
  function setCustomPreview() {
    ...
    prompt(
      ...
      {default: Settlements.getPreview(burg).link, required: false},
      link => {
