...
function showMapTooltip(point, e, i, g) {
  ...
  if (subgroup === "burgIcons") return tip("Click to edit the Settlement");

  if (subgroup === "burgLabels") return tip("Click to edit the Settlement");
...
function showInfo() {
  ...
  alertMessage.innerHTML = /* html */ `<b>SettlementForge Map</b> is an interactive fantasy cartography tool.
    Create terrain, rivers, borders, cultures, and settlements for your world.

    <p>
      This map engine is based on ${link("https://github.com/Azgaar/Fantasy-Map-Generator", "Azgaar's Fantasy Map Generator")} (MIT License).
      The original project is community-backed — consider supporting the author on ${Patreon}.
    </p>

    <p>
      For help with the map tools, check the ${QuickStart}, the ${QAA}, and ${VideoTutorial}.
      Community support is available on ${Discord} and ${Reddit}.
    </p>

    <ul style="columns:2">
      <li>${link("https://github.com/Azgaar/Fantasy-Map-Generator", "Original project")}</li>
      <li>${link("https://github.com/Azgaar/Fantasy-Map-Generator/blob/master/LICENSE", "MIT License")}</li>
