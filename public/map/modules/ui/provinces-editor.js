...
function editProvinces() {
  ...
  function provincesEditorAddLines() {
    ...
    for (const p of filtered) {
      ...
      >
        ...
        <div data-tip="Settlements count" class="provinceBurgs hide">${p.burgs.length}</div>
  ...
  function declareProvinceIndependence(provinceId) {
    ...
    capital.capital = 1;
    Settlements.changeGroup(capital);
  ...
  function addProvince() {
    ...
    const type = Settlements.getType(center, parent.port);
  ...
  function downloadProvincesData() {
    ...
    let data = `Id,Province,Full Name,Form,State,Color,Capital,Area ${unit},Total Population,Rural Population,Urban Population,Settlements\n`; // headers
