...
function showElevationProfile(data, routeLen, isRiver) {
  ...
  function downloadCSV() {
    let csv =
      "Id,x,y,lat,lon,Cell,Height,Height value,Population,Settlement,Settlement population,Biome,Biome color,Culture,Culture color,Religion,Religion color,Province,Province color,State,State color\n"; // headers
