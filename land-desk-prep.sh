...
sh $SC/replay-cars.sh $SC/laneDESKINT "$BASE" $SC/laneINTEG-tree:90702c3e9 $SC/laneWARFAITH:940d161ca $SC/laneGEN2:940d161ca $SC/laneDEF2:940d161ca $SC/laneECON2:940d161ca $SC/laneDESK9:940d161ca | tail -12 $SC/laneENC4B:7be568047 $SC/laneCHARSET2:df7cdd37e $SC/laneHOR2:5e28d5c83 $SC/laneSEAT78:5e28d5c83 $SC/laneROSTER:ec1b5e3e9
