...
sh $SC/replay-cars.sh $SC/laneDESKINT "$BASE" $SC/laneINTEG-tree:90702c3e9 $SC/laneWARFAITH:940d161ca $SC/laneGEN2:940d161ca $SC/laneDEF2:940d161ca $SC/laneECON2:940d161ca $SC/laneDESK9:940d161ca | tail -12
