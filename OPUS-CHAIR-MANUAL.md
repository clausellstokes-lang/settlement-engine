...
Every path below uses `$SC` = `/private/tmp/claude-502/-Users-cstokes-Desktop-settlement-engine/4e3d2f70-f45f-4e14-b571-514c339cfa17/scratchpad/kit` (the program's kit; it has survived every session, account switch and one reboot) and `$REPO` = `/Users/cstokes/Desktop/settlement-engine`.
