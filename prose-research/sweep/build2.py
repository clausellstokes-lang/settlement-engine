import json, os, sys
os.chdir('/private/tmp/claude-502/-Users-cstokes-Desktop-settlement-engine/26b2203a-14d7-409e-a7aa-8d0f3b0517db/scratchpad/prose-research/sweep')
sys.path.insert(0,'.')
...
C(file="grimdark.txt", feature="other: realism justification",
  ...
  quote="fundamentally dishonest if you write a war story and you leave that out", page="section 'A Savage Beast in Every Man'",
...
C(file="bookpage.txt", feature="withheld information and inference",
  ...
  quote="I didn’t want to get too close to the so-called present day of Westeros", page="feature body",
