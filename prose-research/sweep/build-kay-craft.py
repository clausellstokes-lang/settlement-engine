#!/usr/bin/env python3
"""Build found-kay-craft.json + find-kay-craft.md from the sweep notes.
Every quote is validated to be <= 11 words (i.e. under twelve)."""
import json, sys, datetime

OUT = "/private/tmp/claude-502/-Users-cstokes-Desktop-settlement-engine/26b2203a-14d7-409e-a7aa-8d0f3b0517db/scratchpad/prose-research/sweep"

# ---------------------------------------------------------------- sources
# (title, url, kind, substantive)
SOURCES = [
 ("The Fantastic Worlds of Guy Gavriel Kay (Christine Fischer Guy interview, 2016-08-14)", "https://lareviewofbooks.org/article/fantastic-worlds-guy-gavriel-kay/", "interview (LARB)", True),
 ("Altering the Familiar: Tigana by Guy Gavriel Kay (Joshua Palmatier, 'That Was Awesome! Writers on Writing', 2016-07-06)", "https://reactormag.com/2016/07/06/altering-the-familiar-tigana-by-guy-gavriel-kay/", "craft essay by a novelist (Tor.com/Reactor)", True),
 ("The 'Quarter Turn' of History: A Conversation with Guy Gavriel Kay (Chris Urie, 2016)", "https://clarkesworldmagazine.com/kay_interview/", "interview (Clarkesworld)", True),
 ("Guy Gavriel Kay Talks Progress in Alternate History ... in His Reddit AMA (Reactor highlights, 2016)", "https://reactormag.com/guy-gavriel-kay-reddit-ama-highlights-children-of-earth-and-sky/", "author Q&A highlights (r/fantasy AMA via Reactor)", True),
 ("Home and Away (Kay essay; keynote, Globe and Mail short version 1999)", "https://brightweavings.com/globe/", "author essay", True),
 ("Interview in the Historical Novels Review (Teresa Basinski Eckford, Nov 2004)", "https://brightweavings.com/hsparalleluniverses/", "interview", True),
 ("Guy Gavriel Kay: Margins of History (Locus feature, 2025)", "https://locusmag.com/feature/guy-gavriel-kay-margins-of-history/", "interview (Locus)", True),
 ("Locus Online: Guy Gavriel Kay interview excerpts (Sept 2007)", "https://www.locusmag.com/2007/Issue09_Kay.html", "interview excerpts (Locus)", True),
 ("Gary K. Wolfe reviews Guy Gavriel Kay — Children of Earth and Sky (Locus, June 2016)", "https://locusmag.com/2016/06/gary-k-wolfe-reviews-guy-gavriel-kay/", "critic review (Locus)", True),
 ("Interview with Guy Gavriel Kay (Raymond H. Thompson, Camelot Project, 1989)", "https://d.lib.rochester.edu/camelot/text/interview-with-guy-gavriel-kay.html", "interview (academic archive)", True),
 ("Guy Gavriel Kay interviewed (Sandy Auden, infinity plus, 2005)", "https://www.infinityplus.co.uk/nonfiction/intggk.htm", "interview", True),
 ("A Conversation With Guy Gavriel Kay (Alaya Dawn Johnson, Fantasy Magazine, 2008-12-09)", "https://psychopomp.com/fantasy/miscellaneous/a-conversation-with-guy-gavriel-kay/", "interview", True),
 ("Interview: Guy Gavriel Kay on A Brightness Long Ago, Tolkien, Reimagining History (Greg Cook, Wonderland, 2019-04-28)", "https://gregcookland.com/wonderland/2019/04/28/guy-gavriel-kay/", "interview", True),
 ("Author Interview: Guy Gavriel Kay (Far Beyond Reality, 2013-03-19)", "https://farbeyondreality.com/2013/03/19/author-interview-guy-gavriel-kay/", "interview", True),
 ("Interview with Guy Gavriel Kay (Fantasy Cafe, 2013-03-21)", "https://www.fantasybookcafe.com/2013/03/interview-with-guy-gavriel-kay/", "interview", True),
 ("New Guy Gavriel Kay interview (Pat's Fantasy Hotlist, 2019-05-08)", "http://fantasyhotlist.blogspot.com/2019/05/new-guy-gavriel-kay-interview.html", "interview", True),
 ("Guy Gavriel Kay on why writing fantasy fiction about destiny, dominion and deceit will never go out of style (CBC Books, 2019)", "https://www.cbc.ca/books/guy-gavriel-kay-on-why-writing-fantasy-fiction-about-destiny-dominion-and-deceit-will-never-go-out-of-style-1.5206593", "interview", True),
 ("I Drove 12 Hours to Meet Guy Gavriel Kay (Transmissions from Tomorrow, May 2026)", "https://transmissionsfromtomorrow.substack.com/p/meeting-guy-gavriel-kay-what-he-told", "interview/essay (Substack)", True),
 ("The Big Idea: Guy Gavriel Kay — Written on the Dark (Whatever, 2025-05-28)", "https://whatever.scalzi.com/2025/05/28/the-big-idea-guy-gavriel-kay-4/", "author essay", True),
 ("Guest Editor, Guy Gavriel Kay (LoveReading, 2021-03-31)", "https://www.lovereading.co.uk/blog/guest-editor-spring-2021-guy-gavriel-kay-8615", "author essay on admired books", True),
 ("Balancing characters and themes (Kay, Goodreads author blog, 2018-11-07)", "https://www.goodreads.com/author_blog_posts/17550151-balancing-characters-and-themes?tab=book", "author blog post", False),
 ("Some Writing Advice: Don't Take Others' Advice (Kay, LitHub, 2019-05-15)", "https://lithub.com/some-writing-advice-dont-take-others-advice/", "author essay", False),
 ("Tigana — BrightWeavings book page (excerpt of Kay's tenth-anniversary afterword)", "https://brightweavings.com/books/books/tigana/", "publisher/fan-site page with afterword excerpt", False),
 ("Mosaics and charioteers: Guy Gavriel Kay's Sarantine Mosaic (Jo Walton, orig. tor.com; BrightWeavings 2016-05-07)", "https://brightweavings.com/mosaics-and-charioteers-guy-gavriel-kays-sarantine-mosaic/", "critic/novelist review", True),
 ("Ambiguities and Divided Loyalties: Focalization in Guy Gavriel Kay's Tigana (Roosa Toyryla, BA thesis, Helsinki 2017)", "https://brightweavings.com/ambiguities-and-divided-loyalties-focalization-in-guy-gavriel-kays-tigana/", "academic thesis", True),
 ("Present Reality in Historical Fantasy (Anya Kleander, dissertation, Stirling 2008)", "https://brightweavings.com/presentreality/", "academic dissertation", True),
 ("Fantasies of History: Guy Gavriel Kay's Synthesis of the Historical Fantasy Novel (Matthew Rettino, honours thesis 2012)", "https://brightweavings.com/fantasies-of-history-guy-gavriel-kays-synthesis-of-the-historical-fantasy-novel/", "academic thesis", True),
 ("History as Fantasy: My Honours Thesis on Guy Gavriel Kay Summarized (Matthew Rettino, 2013-04-29)", "https://matthewrettino.com/2013/04/29/history-as-fantasy-my-honours-thesis-on-guy-gavriel-kay-summarized/", "academic summary blog", True),
 ("Myth and the New High Fantasy: Guy Gavriel Kay's Tigana (Janeen Webb, The Ring Bearer 8.2, 1991)", "https://brightweavings.com/webbtigana/", "academic essay", True),
 ("Guy Gavriel Kay and the Psychology of History (Christopher Cobb, Foundation, 2005)", "https://brightweavings.com/hspsychologyhistory/", "academic essay", True),
 ("The World-Building of Guy Gavriel Kay (Holly E. Ordway, 1998)", "https://brightweavings.com/worldbuilding/", "academic essay", True),
 ("The Creative Construction of History in Guy Gavriel Kay's The Sarantine Mosaic (Jillian Hatch, 2005)", "https://brightweavings.com/creative_history/", "student paper", True),
 ("Reviews of The Lions of Al-Rassan (collected press reviews: Sagara, Barbour, Kilheffer, Riskind)", "https://brightweavings.com/revlions/", "collected press reviews", True),
 ("Review: Children of Earth and Sky (Russ Allbery, 2022-02-21)", "https://www.eyrie.org/~eagle/reviews/books/0-698-18327-4.html", "reader-critic review", True),
 ("Review: Under Heaven (Russ Allbery, 2010-11-23)", "https://www.eyrie.org/~eagle/reviews/books/0-451-46330-7.html", "reader-critic review", True),
 ("Written on the Dark: Feels like Kay's most elegiac work (Bill Capossere & Rob Rhodes, FantasyLiterature, 2025)", "https://fantasyliterature.com/reviews/written-on-the-dark/", "critic review", True),
 ("Review of Children of Earth and Sky (H.P., Every Day Should Be Tuesday, 2016-05-10)", "https://everydayshouldbetuesday.wordpress.com/2016/05/10/review-children-of-earth-and-sky-guy-gavriel-kay/", "blog review (critical)", True),
 ("Review: All the Seas of the World (L.A. Smith, 2022)", "https://lasmithwriter.com/review-all-the-seas-of-the-world-by-guy-gavriel-kay/", "novelist's blog review", True),
 ("Review of The Lions of Al-Rassan (Jesse, Speculiction, 2012-01-26)", "http://speculiction.blogspot.com/2012/01/review-of-lions-of-al-rassan-by-guy.html", "blog review", True),
 ("Fantasy Novel Review: The Lions of Al-Rassan (Tar Vol on, 2021-02-04)", "https://www.tarvolon.com/2021/02/04/fantasy-novel-review-the-lions-of-al-rassan-by-guy-gavriel-kay/", "blog review", True),
 ("Book Review: The Lions of Al-Rassan (Nick Wisseman, 2022-09-02)", "https://www.nickwisseman.com/single-post/book-review-the-lions-of-al-rassan-by-guy-gavriel-kay", "novelist's blog review", True),
 ("THE LIONS OF AL-RASSAN — Guy Gavriel Kay (1995) (Bormgans, Weighing a pig, 2022-04-21)", "https://schicksalgemeinschaft.wordpress.com/2022/04/21/the-lions-of-al-rassan-guy-gavriel-kay-1995/", "blog review (critical)", True),
 ("The Lions of Al-Rassan (Helen, She Reads Novels, 2013-08-17)", "https://shereadsnovels.com/2013/08/17/the-lions-of-al-rassan-by-guy-gavriel-kay/", "blog review", False),
 ("Review: Under Heaven (Vanessa, Elitist Book Reviews, 2010-08-04)", "https://elitistbookreviews.com/2010/08/04/under-heaven/", "blog review", True),
 ("Under Heaven (Little Red Reviewer, 2012-09-14)", "https://littleredreviewer.wordpress.com/2012/09/14/under-heaven-by-guy-gavriel-kay/", "blog review", True),
 ("Under Heaven book review (Floresiensis, Fantasy Book Review)", "https://www.fantasybookreview.co.uk/Guy-Gavriel-Kay/Under-Heaven.html", "review", True),
 ("River of Stars (Casey Blair, Fantasy Book Critic, 2013-03-26)", "https://fantasybookcritic.blogspot.com/2013/03/river-of-stars-by-guy-gavriel-kay.html", "novelist's review", True),
 ("River of Stars (Stefan, Far Beyond Reality, 2013-04-02)", "https://farbeyondreality.com/2013/04/02/river-of-stars-by-guy-gavriel-kay/", "blog review", True),
 ("A Brightness Long Ago book review (Fantasy Book Review, 2019)", "https://www.fantasybookreview.co.uk/Guy-Gavriel-Kay/A-Brightness-Long-Ago.html", "review", True),
 ("Review: A Brightness Long Ago returns us to Batiara (Domise, Globe and Mail, May 2019)", "https://www.theglobeandmail.com/arts/books/reviews/article-guy-kays-a-brightness-long-ago-returns-us-to-the-fictional-world-of/", "newspaper review", True),
 ("Finding the Light in Written on the Dark (Bend, Goodreads blog, 2025-05-20)", "https://www.goodreads.com/author_blog_posts/25773345-finding-the-light-in-written-on-the-dark-by-guy-gavriel-kay", "blog review", True),
 ("Book review: The Sarantine Mosaic (David, Anywayward, 2020-10-04)", "https://anywayward.com/book-review-the-sarantine-mosaic-by-guy-gavriel-kay/", "blog review", True),
 ("Novel Review — The Sarantine Mosaic (Apocryphal, Tabletop Roleplayers' Book Club, Dec 2018)", "https://www.ttrpbc.com/discussion/120/novel-review-the-sarantine-mosaic-by-guy-gavriel-kay", "game-master book club review", True),
 ("Inspiration — The Lions of al-Rassan (Professor Pope GM blog, 2010-10-28)", "https://www.professorpope.com/2010/10/inspiration-lions-of-al-rassan.html", "game-master blog", True),
 ("Talk to me of Guy Gavriel Kay (RPGnet forum thread)", "https://forum.rpg.net/index.php?threads/talk-to-me-of-guy-gavriel-kay.898766/", "RPG forum thread", True),
 ("Question regarding Guy Gavriel Kay's books (SFFWorld forum, 2011-12-06)", "https://www.sffworld.com/forum/threads/question-regarding-guy-gavriel-kays-books.32913/", "forum thread", True),
 ("Omniscient Narration — Pros and Cons? (SFF Chronicles forum, 2023)", "https://www.sffchronicles.com/threads/584130/", "forum thread", False),
 ("Flippant Reviews: Guy Gavriel Kay (Michal, One Last Sketch, 2011-12-12)", "https://onelastsketch.wordpress.com/2011/12/12/flippant-reviews-guy-gavriel-kay/", "blog review essay (critical)", True),
 ("ggk in transition — Tigana (Brok3n Engines, 2025-04-16)", "https://www.brok3nengines.com/p/ggk-in-transition", "Substack review", True),
 ("A Blue Review of Tigana (Ivana Split, 2025-09)", "https://modaodaradosti.blogspot.com/2025/09/a-blue-review-of-tigana-fantasy-novel.html", "blog review", True),
 ("The Fionavar Tapestry (Ben Babcock, Kara.Reviews, 2010)", "https://kara.reviews/the-fionavar-tapestry/", "blog review (critical)", True),
 ("Fantasy as Memory: The Historical Imagination of Guy Gavriel Kay (Chris McBean, Rowanwood Chronicles, 2025-12-24)", "https://therowanwoodchronicles.blog/2025/12/24/fantasy-as-memory-the-historical-imagination-of-guy-gavriel-kay/", "blog essay", True),
 ("The fantastic fiction of Guy Gavriel Kay (Bob Tarantino, C2C Journal, 2016-09-07)", "https://c2cjournal.ca/2016/09/the-fantastic-fiction-of-guy-gavriel-kay/", "magazine essay", True),
 ("The World of Guy Gavriel Kay (Ashley Barnard, Fantasy-Faction, March 2011)", "https://fantasy-faction.com/2011/the-world-of-guy-gavriel-kay", "fan-magazine essay/interview", True),
 ("Where to Start? — Guy Gavriel Kay (The Wertzone, 2010-04)", "https://thewertzone.blogspot.com/2010/04/where-to-start-guy-gavriel-kay.html", "blog reading guide", False),
 ("Paid post book review: Written on the Dark (Omnivorous, Substack, 2025)", "https://omnivorous.substack.com/p/paid-post-book-review-written-on", "Substack review (paywalled)", False),
]

# ---------------------------------------------------------------- claims
# (feature, claim, source, url, quote)
C = []
...
add("no worldbuilding system", "Kay says he has no system for building interconnected societies; he learns the real theme before doing variations on it.", *CW, "you should at least try to know the theme")
...
add("register modulation by period form", "Kay shapes the language and the form of the telling to the period's own literary forms, e.g. saga elements for the Viking-era Last Light of the Sun.", *HNR, "shape language and form of telling the tale using saga elements")
add("faiths without tenets", "Kay's invented religions keep the interplay of faiths but drop the doctrines, so readers' real-world prejudices cannot attach.", *HNR, "interplay of faiths, without the tenets, to strip prejudice")
...
LM = ("Locus, 'Margins of History', 2025", "https://locusmag.com/feature/guy-gavriel-kay-margins-of-history/")
...
TFT = ("Miller, Transmissions from Tomorrow, May 2026", "https://transmissionsfromtomorrow.substack.com/p/meeting-guy-gavriel-kay-what-he-told")
...
add("accessibility without prior knowledge", "Readers who know nothing of the underlying history should never feel behind.", *TFT, "don't feel they're behind")
...
add("yesterday's snows", "Writing about the past lets Kay say things that resonate when readers look up at their own time.", *BI, "write about yesterday's snows and say things that might resonate")
...
add("withheld identity", "Kay describes a character for two pages without saying who it is.", *JW, "doesn't say who it is for two pages")
...
add("scene narrated twice or thrice", "The ritual scene where storylines converge is narrated two or three times through different focalizers.", *TOY, "narrated twice or even thrice")
...
add("matter-of-fact violence", "A dramatic, violent event is narrated in a flat, matter-of-fact style.", *TOY, "matter-of-fact style is used to describe a dramatic and violent event")
...
add("ignorant protagonist as exposition device", "Devin's absence of knowledge lets secondary-world details reach the reader without lecture.", *KL, "protagonist's 'absence of knowledge' is a common device in fantasy")
...
add("prologue as mosaic", "The prologue of Sailing to Sarantium is non-focalized omniscient narration written, in Kay's words, as mosaic.", *KL, "the prologue of Sailing to Sarantium was written as mosaic")
add("echo not copy", "Kay's historical method is an echoing of elements, not a copying.", *KL, "An echoing of elements, not a copying")
...
add("sensory particularity for aesthetic response", "The prose lingers on light, colour and spatial position when depicting a character's aesthetic response to loss.", *COBB, "")
...
add("focalization as tesserae", "Shifting focalization works like mosaic tesserae whose colours play against and with each other.", *HATCH, "colours of a mosaic 'play against each other and with each other'")
...
REV = ("Collected press reviews of Lions (Kilheffer F&SF; Sagara Quill & Quire; Barbour Edmonton Journal)", "https://brightweavings.com/revlions/")
...
add("restraint, drama turned up at climax", "Under Heaven is mostly restrained but the dramatic narration is turned up a bit too high around the climax.", *RA2, "Kay does turn up dramatic narration a bit too high")
add("background stays background", "Kay lets research stay in the background rather than hammering the reader with it.", *RA2, "let background be background")
add("conversation as pacing engine", "Long conversations do pacing, characterization and repeated broadening and revelation at once.", *RA2, "pacing, characterization, repeated broadening and revelation")
...
add("triple restatement", "A hostile reading: Kay never says once what he can say twice or three times.", *HP, "never says once what he can say twice")
add("staccato short sentences", "Kay's short sentences produce a staccato beat the reviewer finds awkward.", *HP, "There is a staccato beat to his short sentences")
add("confusing mid-scene POV shifts", "Switching back and forth between POVs mid-scene can disorient.", *HP, "switches back and forth between POVs in the middle")
...
add("formal language balanced with brevity", "Lions balances formal diction against a brevity that depends more on action than words.", *SPEC, "balance struck between formal use of language and brevity")
add("subtle tone, delayed reveals", "Reveals are not immediate and the tone is subtle rather than explicit.", *SPEC, "reveals not immediate and tone is subtle")
add("tributary structure", "Secondary storylines feed the main plot like tributaries into a river.", *SPEC, "tributaries feeding larger river")
...
add("'this was the moment' tic", "Under Heaven repeats the intrusion that a character knew this was the moment that would change his life.", *OLS, "the moment that would change his life forever")
add("overwrought reminiscence", "Tigana's reminiscences on the lost province read as overwrought to this reviewer.", *OLS, "overwrought reminisces")
add("verbal trickery hiding results", "Lions hides the duel's result through verbal trickery until the last possible moment, which wears thin.", *OLS, "hides the result until the last possible moment")
add("told how to feel", "Readers are told how to feel about historical moments rather than experiencing the consequences.", *OLS, "told how to feel")
...
add("impressionistic language", "Kay's writing is evocative, even impressionistic in places, transporting with simple word choices.", *PAL, "evocative, even impressionistic in places")
...
add("lyrical without flowery", "Kay's writing is lyrical without being flowery; readers pause to savour single sentences.", "Ashley Barnard, Fantasy-Faction, March 2011", "https://fantasy-faction.com/2011/the-world-of-guy-gavriel-kay", "lyrical without being flowery")
...
add("numinous not apprehended directly", "The divine is framed as not to be directly apprehended; horror is rendered through the mind's refusal.", *TT, "The numinous is not to be directly apprehended.")
...
# ---------------------------------------------------------------- validate
bad = [c for c in C if len(c["quote"].split()) > 11]
if bad:
    for b in bad: print("TOO LONG:", len(b["quote"].split()), b["quote"])
    sys.exit(1)
urls = {s[1] for s in SOURCES}
missing = sorted({c["url"] for c in C} - urls)
if missing:
    print("CLAIM URL NOT IN SOURCES:", missing); sys.exit(1)
...
# ---------------------------------------------------------------- notes
lines = ["# Sweep notes — Guy Gavriel Kay, craft-essay angle", f"Generated {datetime.date.today().isoformat()} from the session's fetches. Web-search budget hit 200/200 after ~35 queries; consolidation stopped there (two of the last three query rounds were returning already-seen pages).", "",
         "## Method", "- Queries issued (representative): 'Kay prose style analysis sentence rhythm register craft essay'; 'Home and Away essay quarter turn'; 'Jo Walton Tigana reread'; 'omniscient narrator flash-forward would remember'; per-book prose reviews (Lions, Under Heaven, Sarantine, River of Stars, A Brightness Long Ago, Written on the Dark); 'Kay influence game design'; 'Kay tabletop RPG GM'; negation searches 'overwrought OR purple OR mannered OR tics'; academic 'Journal of the Fantastic in the Arts / Mythlore'; 'Locus interview'; 'Reddit AMA'.",
         "- Every cited page was fetched (WebFetch, or curl+archive.org where WebFetch was 403/307: LARB, Clarkesworld, Reactor x2, Locus x3, CBC, FantasyLiterature, RPGnet, Hotlist). Pages that could not be read (Locus Wolfe/ABLA, Locus 'Journeying', core.ac.uk) are NOT cited.",
         "- Negation search found the dissenting critics (One Last Sketch, H.P., Bormgans, RPGnet poster, Brok3n Engines) — their claims are labelled '(dissent)' or phrased as the critic's reading.", "",
         "## Convergent findings (what several independent readers agree on)",
         "1. **Veiled / commentating omniscience**: a tight third that also carries authorial commentary, foreshadowing and future-tense asides (Walton 'veiled omniscient'; Allbery 'soundtrack'; Blair 'pulling back'; Stefan 'sotto voce'; FantasyLiterature 'it would afterwards be said'). Dissenters call the same device portentous/heavy-handed (H.P., One Last Sketch, RPGnet).",
         "2. **Withholding**: identity withheld for pages (Walton), aftermath-first then flashback (Tar Vol on), foreshadow-then-cut-away and dead-character misdirection (Wisseman), off-stage action (Kilheffer), the Lions duel engineered so grief runs both ways (Kay, AMA).",
         "3. **Competing tellings of one event**: same conversation from two participants differs (Kay, LARB); ritual scene narrated twice/thrice (Toyryla); same events via several viewpoints (FBR); Uskoks seen by Venice vs themselves (Kay, Clarkesworld); Pertennius's biased chronicle (Hatch).",
         "4. **Register**: formal diction balanced by brevity (Speculiction); laconic sentences against lyric (Anywayward); pluperfect-heavy (Walton); cadence over density, no invented terminology (Rowanwood); 'lyrical without flowery' (Barnard); register shaped by period form — saga elements for Last Light, detached-historian voice for River of Stars (Kay); chronicle-like openings (Rettino); archaic inversion for the numinous (Ordway); contemporary idiom occasionally leaks (Kilheffer).",
         "5. **Restraint**: stiletto not bludgeon (Kay); emotion by what is not said (Rowanwood, Blair); sparse description (Domise); matter-of-fact violence (Toyryla); oblique violence (Anywayward); glinting/unexplained magic (Walton, Kay AMA, Elitist, Wolfe).",
         "6. **Ordinary people / no minor characters**: walk-ons given depth (Wolfe); refusal of 'minor' (FantasyLiterature); secondary characters as could-have-been novels, a saga motif (Kay AMA); interludes for peripheral lives (Smith); one-off viewpoints (Blair).",
         "7. **History as residue / melancholy**: 'things left behind and yet stayed with you' (Cobb); memory, foreknowledge, reflective distance (Rowanwood); provisional triumphs; elegiac close (Rettino); chronology opening at the end (Wolfe); sweet-and-sorrowful (FantasyLiterature).", "",
         "## Game-design angle", "- Thin. Found: a tabletop book-club review (ttrpbc: denouement length, numinous), a GM blog (Professor Pope: light-touch magic, story-game not D&D), an RPGnet thread. Kay himself contrasts his unexplained magic with 'gaming-inspired fantasy' that goes into rules and clarity (AMA). No narrative designer citing Kay was found (searched Dragon Age/Gaider — nothing).", "",
         "## Open questions / not found", "- Kay's Tigana tenth-anniversary afterword full text (only an excerpt on BrightWeavings). - Locus Wolfe review of A Brightness Long Ago and Locus 'Journeying' (not archived). - No source directly analyses the 'X would remember this, years later' flash-forward by name beyond One Last Sketch's paraphrase and FantasyLiterature's quoted instance.", "",
         "## Sources read", ""]
for s in sources:
    lines.append(f"- [{'S' if s['substantive'] else '-'}] {s['title']} — {s['kind']} — {s['url']}")
lines += ["", "## Claims", ""]
for c in C:
    q = f' — "{c["quote"]}"' if c["quote"] else ""
    lines.append(f"- **{c['feature']}** — {c['claim']} ({c['source']}; {c['url']}){q}")
open(f"{OUT}/find-kay-craft.md","w").write("\n".join(lines)+"\n")
print("claims", len(C), "sources", len(sources), "substantive", sum(1 for s in sources if s["substantive"]))
