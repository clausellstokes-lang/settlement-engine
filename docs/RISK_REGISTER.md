...
| ~~R7~~ | ✅ done | A11y now has dynamic interaction coverage beyond static lint: focus-trap, live-region announcement, and view-change focus tests. **Fixed.** | `tests/ui/a11y.audit.test.jsx` | — |
