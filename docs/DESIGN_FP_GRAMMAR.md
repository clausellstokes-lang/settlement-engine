...
| Fraying legibility: `frayingTermOf`, `treatyFrayingSummary`, `treatyDocument`, house-voice totality table | `peaceTermsDocument.js:150` (`frayingTermOf`), `peaceTerms.js:1262` (`treatyFrayingSummary`); `display/treatyDocument.js:36-60` | BUILT |
...
| Longevity: `mintedTick`/`signedTick` persisted, `yearsRemaining` rendered; AGE never computed or spoken; no anniversary, no eulogy | `peaceTerms.js:213` (`mintedTick`), `:269` (`signedTick`) | ABSENT — GR-0 |
