...
|---|---|---|---|---|---|
| LANDING | TE-PRODUCERS-LANDING (resume, Fable) | lanePRODUCERS-tree @ 3008719a | lanePRODUCERS-receipt.md | §§1–6 proven; S0 → sweep → terminal `producers-TERMINAL-3008719a.log` + `producers-TERMINAL-exit.txt` | collect the terminal if it ran; else resume; CAS `421c7345 → 3008719a` on green; prune holding-t2r/t2q/t2n |
