...
|---|---|---|---|---|---|
| LANDING | TE-UCSTACK-LANDING (Fable) | laneUCSTACK-tree @ 006c07be(+1 cure) | laneUCSTACK-receipt.md | §474 cure (A6 → positive control + outsiders=[]) → follow-on → sweep → terminal `ucstack-TERMINAL-<newtip8>.log` + `ucstack-TERMINAL-exit.txt` | collect the terminal if it ran; else resume; CAS `f32c548e → <new tip>` on green; prune holding-uc0/uc3 |
