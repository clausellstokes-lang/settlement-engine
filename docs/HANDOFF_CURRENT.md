...
| research | TC-R-INST-3 (resume, Fable, solo) | — | laneTCRINST3-receipt.md · draft-R-INST-3-FAITH-LEARNING.md | faith + learning interiors from the status map (deity doctrine first) | resume from the status map |
