...
clerk, never writer) · setting-agnostic, sub-century, never a named character's
fate.

## Topology (two branches, two worktrees, one scratchpad)
- LEDGER branch `review-fixes-2026-07-08`: docs/OWNER_DECISION_QUEUE.md (THE
  record, currently §233) + this file. The MAIN worktree
  (/Users/cstokes/Desktop/settlement-engine) MATCHES NO BRANCH — commit to the
