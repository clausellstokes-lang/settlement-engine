...
|---|---|---|---|---|---|
| LANDING | TE-WEB7-LANDING | laneTEWEB7-tree | laneTEWEB7-receipt.md §"THE LANDING SLOT … slot 2b82121f" | rebasing e5975829 onto 2b82121f; tip in `web7-rebased-tip.txt`; terminal `web7-TERMINAL-<tip8>.log` + `web7-TERMINAL-exit.txt` | collect the terminal if it ran; else resume from the receipt; CAS `2b82121f → <tip>` on green |
...
| research | TC-R-INST-2 (Fable) | — (scratchpad only) | laneTCRINST2-receipt.md · draft-R-INST-2-TRADE-CRAFTS.md | trade/commerce/crafts interiors, written in place with RESUME POINTs | resume from the dossier status map + receipt |
