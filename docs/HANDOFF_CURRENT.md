...
| compile | TC-WEBSITE-2 (redispatch, Fable, solo) | — | laneTCWEBSITE2-receipt.md · draft-WEBSITE-PLAN-2.md (written in place) | WEB-8 + WEB-9 charters per §464.2 | resume from the receipt |
