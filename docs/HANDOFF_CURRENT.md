...
⭐ **STATE AT §687 (2026-08-26):** ledger `review-fixes-2026-07-08` through **§687** · **GROW-FOLD SEALED** = `refs/preserve/map-sandbox-gfold-order` = **`56ee43dad`** (§686 — the raise precedes its growth; metropolis 2,633 → 2,748; band median **1.71**, the reference invariant; C1's magnitude re-based and §655.3 closed) · **DRESS-1 IN FLIGHT** on that seal (brief at `$SP/briefs/DRESS1-BRIEF.md`, receipt `laneDRESS1-receipt.md`) · **`docs/PROVENANCE_MAP.tsv`** is the standing provenance instrument (693 rows; **130 UNKNOWN in four runs — §18–§23, §287–§290, §311, §322–§439** — that is the genuinely owed surface, not the 608 the text-silence count suggests).
