...
COMPLETE AND PINNED (holding for landing slots): UC-3 `64a4b259` (holding-uc3; T-UC1 #2) · WEB-2 `1d93458a` (holding-web2; migration 198, the first DESTRUCTIVE one — lands after the map stack) · UC-0 `a5c6c4fa` (holding-uc0; lands as T-UC1 #1 after the map stack) · T2R `f65b3ff3` (holding-t2r) · T2Q `cc9ef856` (holding-t2q; squash at landing) · T2N `9f05fbb4` (holding-t2n) · T2J `f7ba3145` · T2K `4d2d17f8` · T2L `6c920593` · T2M `faf3def4` (ALL FOUR in the landing seat as the stack).
