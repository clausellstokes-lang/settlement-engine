...
|---|---|---|---|---|---|
| LANDING | TE-PRODUCERS-LANDING (Fable) | lanePRODUCERS-tree (fresh, from f65b3ff3) | lanePRODUCERS-receipt.md | T2R→T2Q(squashed)→T2N rebased in sequence onto 421c7345; three packets at LANDED; tip in `producers-rebased-tip.txt`; terminal `producers-TERMINAL-<tip8>.log` + `producers-TERMINAL-exit.txt` | collect the terminal if it ran; else resume from the receipt; CAS `421c7345 → <final tip>` on green; prune holding-t2r/t2q/t2n |
...
| compile | TC-WEBSITE-2 (Fable, solo) | — | laneTCWEBSITE2-receipt.md · draft-WEBSITE-PLAN-2.md | WEB-8 + WEB-9 charters per §464.2 | resume from the receipt |
