...
| verify | SKEPTIC over draft-WEBSITE-PLAN-2 (Opus, single agent) | — | result in the successor tasks/ dir | three lenses in one brief; the chair rules §471 on its return | if dead: re-dispatch the same brief |
