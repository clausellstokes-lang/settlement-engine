...
**AS OF 2026-08-23 21:55 CDT · ledger §518 · ⭐⭐ DW-R RESEARCH COMPLETE · ⛔ EVERY DISPATCH `model: "opus"` (§484) · build `claude/composite-r4` = `5055990a` (48 landings; 0 READY across 170 packets; `undercityHighWaterEnabled` on the branch DARK; migrations 197/198/199 on the branch) · LANE CAP = TWO (§465)**
...
⭐ §518 OWNER-SIGNED SCHEMA: **ownership is FACTION-scoped** (`Estate.ownerRef` = a faction or `ANONYMOUS_FABRIC`); EST-4's household refusal STANDS; the hover halo highlights a FACTION's holdings across the town. Last open question from the sitting — closed.
