...
COMPLETE AND PINNED (holding for landing slots): UC-0 `a5c6c4fa` (holding-uc0; lands as T-UC1 #1 after the map stack) · T2R `f65b3ff3` (holding-t2r) · T2Q `cc9ef856` (holding-t2q; squash at landing) · T2N `9f05fbb4` (holding-t2n) · WEB-5 `6d6572ea` (holding-web5, IN the landing seat) · WEB-6 `5b0a399f` · WEB-7 `e5975829` · T2J `f7ba3145` · T2K `4d2d17f8` · T2L `6c920593` · T2M `faf3def4`.
