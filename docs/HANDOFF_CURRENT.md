...
3. **D2 · density live half** in `laneDENS-tree` (stacked on D1 `1296e7e1b`; FIRST ACT was `git rebase --onto f32f8e7ef b85044099` — ⚠ a killed rebase-in-progress: continue, don't abort; ONE collision expected, the lighting register, take-either-side-then-regenerate). Receipt `laneD2-receipt.md`; D1's is `laneD1-receipt.md`.
