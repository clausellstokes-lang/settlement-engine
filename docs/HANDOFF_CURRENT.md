...
|---|---|---|---|---|---|
| LANDING | TE-WEB2-LANDING (Fable) | laneTEWEB2-tree | laneTEWEB2-receipt.md §"THE LANDING SLOT … slot c1295938" | rebasing 1d93458a onto c1295938 (migration 198; twelve gates at the slot); tip in `web2-rebased-tip.txt`; terminal `web2-TERMINAL-<tip8>.log` + `web2-TERMINAL-exit.txt` | collect the terminal if it ran; else resume; CAS `c1295938 → <tip>` on green; prune holding-web2 |
...
COMPLETE AND PINNED (holding for landing slots): WEB-2 `1d93458a` (IN the landing seat) · WEB-3 `da9d9c40` (holding-web3; after WEB-2) · HK-A `f2b2711b` (holding-hka; D-HKA-1 comment fix at its landing act) · (the map stack LANDED at 421c7345).
