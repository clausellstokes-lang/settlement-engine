...
town-wide wait, a market position, or universal term compliance. Therefore `{npc}`
below binds only to the **FALLEN HOLDER**, never a successor; `{band}` leaves the
block; and variants 2 through 8 are re-authored to say only what a validated pending
row and its current treaty entail. Two distinct pending questions may lawfully point
