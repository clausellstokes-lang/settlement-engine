...
> commits (b503fe05..7a6603de) plus follow-ups; migrations are contiguous to 201 at
...
1. **Migration train.** Working-tree migration head 201 is 1 migration ahead
   ...
   ODQ §934.28 — waits on the owner's `supabase db push`). Both
