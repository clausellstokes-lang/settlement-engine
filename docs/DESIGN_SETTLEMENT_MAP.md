...
### Status: HISTORICAL V1, partially landed and superseded at its truth/renderer/editor seams by ODQ §287 and `map-corpus/docs/GENERATION-SPEC.md` §§6–10. Library placement, hover legibility and **one truth** survive. View-time-only geometry, cosmetic-only generative reroll and a parked living form do not.
