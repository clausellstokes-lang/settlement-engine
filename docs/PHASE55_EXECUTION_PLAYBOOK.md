...
- M5 ARMY-TRANSIT + FIELD COMBAT: COMMITTED (this commit) — mover ladder #5, the war convergence.
  ...
  math). Courier umbilical makes an info-starved army mis-assess. Budget-free. NEXT: M6 (rescoped —
  commodity flow + entrepôts + the greed-vs-danger dispatch EV + flow-derived economics, Round 22).
