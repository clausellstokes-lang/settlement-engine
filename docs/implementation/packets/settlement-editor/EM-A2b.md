...
- **Landed at:** `592336bb679eee73c72bc4957ad326e373e0fa6a` — the thirty-second landing — train EM-T12 (version 7, judgments 134/136/138; its build c0766c614 composed as 592336bb6 with its three packet commits f3976cdaa · 978035af2 · 1160e60da → 11147c5a4 · f2fe5415e · e4cb1a655, each manifest hunk patch-equal over EM-C4a's moved entry): the six world-derived pools join EM-A2a's table — the deity row reading the record door and importing nothing, the resources gate filtering by r.compatible, nine widening edit points across five landed EM-A2a arms (3 files, +393/−13); pools.js EXEMPT in the ruin-filter walker as a DM selection list over the record's own roster, the discovery count 93 → 94 re-measured; the version-6 build's one red cured as version 7; the sixth amendment's §P2.11 form ('the holder at the placement') supersedes this body's 'at the pre-proof' sentence — a lagging sentence left as history
- **Packet version:** 7
