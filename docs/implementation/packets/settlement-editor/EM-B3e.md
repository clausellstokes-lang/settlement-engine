...
- **Landed at:** `49a5f1e01a42e780b65410d0c053423ccef6691e` — the nineteenth landing — train EM-T10: the import and export strips reach a save's version-history snapshots (its §4 branch name and §10/§12 byte-arm holder are lagging sentences left as history)
- **Packet version:** `2`
