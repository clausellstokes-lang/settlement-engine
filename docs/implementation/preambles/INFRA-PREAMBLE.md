...
**THIS FAMILY'S STAMP, AS RECORDED:** **NOT APPLICABLE — AND THEREFORE FOUR.** INFRA is the build-machinery family: it has no design volume and no SPV annex, so there is nothing a §70.4 round could stamp. **INFRA trains cap at FOUR members**, which is the cap the `eff-1a` train that authored this section ran under.
