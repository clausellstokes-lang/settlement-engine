...
| READY-1 | [`TC-3b`](./packets/town-cartography/TC-3B.md) | **READY** at `5066c34b` (C-1 revalidation complete 2026-08-10) | Adds bounded contained parcels and the pure institution-to-parcel binding receipt for TC-4 | naming, schema changes, TC-4..8, buildings, promotion, 3D defaulting, visual soak |
