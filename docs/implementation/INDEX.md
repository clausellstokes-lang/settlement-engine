...
| READY-2 | [`GR-3b`](./packets/foreign-policy/GR-3B.md) | **READY** at `0f78d9c8` (chair promotion 2026-08-10; CR-FP-ORDER position 3, the ORIENT dependency discharged) | Finishes the producer half of GR-3: the frozen rung ladders, selection function, and the composable-pair exception | GR-4+, later grammar, tuning, lighting, orientation edits |
