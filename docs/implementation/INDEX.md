...
- **Measured branch/SHA:** `claude/composite-r4` at the `in-1c-a` train terminal.
- **Measured:** 2026-08-15 — **THE `in-1c-a` TRAIN LANDED (`IN-1C-A`), a SOLE-MEMBER train that
