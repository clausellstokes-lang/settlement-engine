...
| READY-2 | [`GR-3B-ORIENT`](./packets/foreign-policy/GR-3B-ORIENT.md) | **READY** at `820ed989` (chair promotion 2026-08-10; an EP-s veto withdraws it) | Adds the per-term obligation reader (CR-GR3B-3-R1) that GR-3b and IN-0c's transfer semantics consume | GR-3b producers, IN-0c, any persisted-shape change, treatyOrientationOf edits |
