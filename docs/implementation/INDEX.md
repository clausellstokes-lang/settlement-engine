...
- **Measured:** 2026-08-14 — **THE `gap-1` TRAIN IS IN FLIGHT: one member, `GAP-1`,
  promoted READY at `5d6a0e7c`.** The live manifest has 40 rows and one dispatchable
  packet. It cures GAP-1, which lane SD's diagnostic-soak scan ordered and lanes G1
