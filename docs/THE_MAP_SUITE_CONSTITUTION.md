...
> **STATUS — SUPERSEDED FOR THE SETTLEMENT MAP (ODQ §287 / GENERATION-SPEC §§6–10).**
> The four-projection/plan-panorama program is retired in favour of one zero-tilt strict-plan map,
> one leaf at a time. Preserve this document's composite institution silhouette law, deterministic
> semantic DrawOps and typed custom-institution derivation; do not implement M1–M4 as parallel maps.

Owner-ordered at the walk (ledger rows 1d1d5e0d → e1b419a4); this doc is the durable
spec the historical M lanes were designed from. Its former top law was **one townMapModel → four projections
