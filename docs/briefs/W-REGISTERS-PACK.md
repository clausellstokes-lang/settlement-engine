...
**Status:** DRAFT FOR MARKUP (chair, Fable seat, 2026-08-30; ODQ §804). Nothing here is frozen;
nothing freezes without the owner's signature (tuning carve-out, §763). Sources: ODQ §§797–803.2
+ DESIGN_W_LIVES / DESIGN_W_FAITH / DESIGN_W_OPS. **How to mark it up:** strike a row to kill it,
write over a word to rename it, add rows freely — every word must be setting-agnostic and survive
any world. Registers III and IV are drafted here for the FIRST time; everything is a proposal.
...
## REGISTER III — THE EXPERIENCE TABLE (first draft; kinds × plane × family × pulls)

Pull magnitudes are BAND WORDS (faint / firm / heavy), never floats; exact rates are car-1 tuning
rows under your signature. Every kind names its existing receipt family (the source law).

| Kind | Plane | Family | Pulls (toward) |
|---|---|---|---|
| betrayed_by_friend | PERSONAL | bond | TRUST→paranoid heavy · CHEER→bitter firm |
| bereavement_close | PERSONAL | bond | CHEER→bitter firm · DEVOTION→pious faint |
| caught_lying_exposed | PERSONAL | repute | CANDOR→honest firm (chastening) · CHEER→bitter faint |
| corruption_exposed | PERSONAL | repute | JUSTICE→corrupt faint (residue) · TRUST→paranoid firm |
| turned_by_crime | PERSONAL | fall | JUSTICE→corrupt heavy · CANDOR→deceitful firm |
| captured_held | PERSONAL | ordeal | TRUST→paranoid firm · COURAGE→? (owner: hardens or breaks? draft: seeded either, weighted by current COURAGE) |
| ransomed_home | PERSONAL | ordeal | GENEROSITY→generous faint (gratitude) · FIDELITY→loyal firm |
| abandoned_unransomed | PERSONAL | ordeal | FIDELITY→treacherous firm · CHEER→bitter heavy |
| pardoned_released | PERSONAL | ordeal | MERCY→compassionate firm · DEVOTION→pious faint |
| promotion_won | PERSONAL | career | HUMILITY→arrogant faint · CHEER→optimistic firm |
| rung_lost | PERSONAL | career | CHEER→bitter firm · CONTENT→envious firm |
| refused_by_patron | PERSONAL | career | ⚠ taste row 6 — if kept: CHEER→bitter faint · HUMILITY→humble faint |
| goal_culminated | PERSONAL | career | CONTENT→contented firm · TEMPERANCE→indulgent faint |
| survived_battle | PERSONAL | ordeal | MERCY→callous firm · COURAGE→brave faint |
| faction_captured | AFFILIATION | house | TRUST→paranoid firm · JUSTICE→corrupt faint |
| faction_cleansed | AFFILIATION | house | JUSTICE→principled firm · CHEER→optimistic faint |
| house_power_rose / fell | AFFILIATION | house | HUMILITY→arrogant / humble faint · CHEER paired |
| home_occupied | AFFILIATION | realm | MERCY→callous firm · FIDELITY→loyal firm (siege solidarity) |
| home_liberated | AFFILIATION | realm | CHEER→optimistic heavy · FORBEARANCE→forgiving faint |
| coup_at_home | AFFILIATION | realm | TRUST→paranoid heavy · PRUDENCE→prudent faint |
| god_fortunes_rose / fell | AFFILIATION | creed | DEVOTION→pious / worldly firm |
| dwell_milieu (continuous) | WITNESS | milieu | all axes toward host's poles, faint × depth band |
| news_believed_atrocity | WITNESS | word | MERCY→callous faint · TRUST→paranoid faint |
| news_believed_triumph | WITNESS | word | CHEER→optimistic faint · COURAGE→brave faint |
| festival_kept | WITNESS | word | CHEER→optimistic faint · CONTENT→contented faint |
| plague_season_survived | WITNESS | milieu | DEVOTION→pious faint · CHEER→bitter faint |
...
consecration) ride the creed family at heavy, per §800.4's ambient/commitment rule.
