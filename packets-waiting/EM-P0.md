...
- **Last revalidated:** 2026-09-19 12:4x EDT. **The base is kept rather than re-pinned to the tip**, and the J-T1 clause is re-proved by object id: across the **26** commits `d31af2cee..f32b0e984`, all **eight** paths this packet measures — `pipeline.js`, `steps/generatePopulation.js`, `kernel/prng.js`, `kernel/rngContext.js`, `npcGenerator.js`, `power/conflicts.js`, `power/factionGrouping.js`, `tests/fixtures/generator-golden-master.json` — are **byte-identical** (`EM-P0.evidence.md` §P0-E13). The chair re-pins at promotion
