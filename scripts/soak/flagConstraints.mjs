...
export const REQUIRES_ROWS = Object.freeze([
  ...
  ['mediationGeneralizedEnabled', ['warLayerEnabled', 'peaceEngineEnabled'], 'LIT-2 (J-EM-16): the code conjunction mediationPressure.mediationGeneralizedActive, mediationGeneralizedEnabled === true && warLayerEnabled === true && peaceEngineEnabled === true, one gate for both occasions, because every occasion speaks through the treaty stage'],
