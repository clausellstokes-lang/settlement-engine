...
echo "PREDICTED: totalFiles UNCHANGED at 2468 (this consist adds no test file). totalTests REFUSED IN ADVANCE - not derivable without executing the suite; this run IS the derivation. entries 6 -> 6; clampPrimitiveBaseline STAYS banked and STAYS red by design until the final clamp wave."
