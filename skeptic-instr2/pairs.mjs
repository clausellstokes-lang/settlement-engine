...
import { coOccurringPairs, tierRows } from '/private/tmp/claude-502/-Users-cstokes-Desktop-settlement-engine/26b2203a-14d7-409e-a7aa-8d0f3b0517db/scratchpad/skepINSTR2/src/domain/prose/wiringCensus.js';
const { rows, held } = JSON.parse(readFileSync('./rows.json','utf8'));
const j = JSON.parse(readFileSync('/private/tmp/claude-502/-Users-cstokes-Desktop-settlement-engine/26b2203a-14d7-409e-a7aa-8d0f3b0517db/scratchpad/instr-912/firings.json','utf8'));
