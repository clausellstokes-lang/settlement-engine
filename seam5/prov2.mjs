...
import { classifyMoves, clauseUnits, CLAUSE_DETECTORS, orderIdOf } from '/private/tmp/claude-502/-Users-cstokes-Desktop-settlement-engine/26b2203a-14d7-409e-a7aa-8d0f3b0517db/scratchpad/laneSEAM/src/domain/prose/moveGrammar.js';
const D = process.cwd();
const texts = [];
