...
async function applyStyleOnLoad() {
  // SettlementForge embedded mode: default to ancient (parchment) style to match palette
  const isEmbedded = window.parent !== window;
  const defaultPreset = isEmbedded ? "ancient" : "default";
  const desiredPreset = localStorage.getItem("presetStyle") || defaultPreset;
