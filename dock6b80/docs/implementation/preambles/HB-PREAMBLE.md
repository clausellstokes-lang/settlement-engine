...
## §P12 · THE §74 CAP, THE §70.4 STAMP PRECONDITION, AND THE §81.3 STANDING BATTERY TEMPLATES
...
**THIS FAMILY'S STAMP, AS RECORDED:** **NONE RECORDED.** The §70 program closed at seven rounds, stamping WC · WF · EP · POP · INT · WY · TR/IN/CW/ES (ODQ §96.4); **HB is not among them**, and no §70.4 acceptance for this volume appears in the decision queue. **HB trains therefore cap at FOUR members**, engine or prose, until a Fable round stamps the volume and this line is re-measured. ⚠ Do not read the §96.4 summary sentence "every family stamped" as covering HB: the parenthetical in that same ruling is the enumeration, and it is the enumeration that binds.
